...
- name: 麋鹿鲁哟
  desc: 大道至简，知易行难
  avatar: https://jsd.cdn.zzko.cn/gh/moklgydocs/image_store/blog/20200122153807.jpg # 可选
...
```yaml
- name: moklgy's blog # 昵称
  desc: 全栈技术博客，积跬步以至千里 # 介绍
  avatar:  # 头像
  link: https://moklgydocs.github.io/ # 链接
```
