...
<template>
  <div class="wrap" :class="'mode-' + mode" @touchstart="handleTouchstart">
    ...
    <!-- 版权 -->
    <div class="copyright">公众号「OneCore.NET研习社」 ©版权所有</div>
    ...
    <div v-if="isReadImages">
      ...
      <img
        ...
        class="hide-img"
        id="qrcode"
        src="https://jsd.cdn.zzko.cn/gh/moklgydocs/image_store2@master/img/qrcode.zul0pldsuao.png"
      />
    </div>

    <!-- 背景音乐 -->
    <audio
      src="https://jsd.cdn.zzko.cn/gh/moklgydocs/image_store2@master/cjxq.mp3"
      id="bgm"
      ref="bgm"
      loop
    />
...
export default {
  ...
  data() {
    return {
      ...
      bgList: [
        'https://jsd.cdn.zzko.cn/gh/moklgydocs/image_store@master/1.4j8qpdnq80i0.jpeg',
        'https://jsd.cdn.zzko.cn/gh/moklgydocs/image_store@master/4.4460an8ag5o0.jpeg',
        'https://jsd.cdn.zzko.cn/gh/moklgydocs/image_store@master/5.3axtl4xpvy00.jpeg',
        'https://jsd.cdn.zzko.cn/gh/moklgydocs/image_store@master/6.2lnbphdqjaq0.jpeg',
      ],
  ...
  methods: {
    ...
    openPosters() {
      ...
      this.bgList.forEach((item, index) => {
        ...
        ctx.fillText('©公众号「OneCore.NET研习社」', 550, 1420)
...
更多有趣的小网页欢迎关注公众号`OneCore.NET研习社`:
> [手写春联](https://cl.moklgydocs.com/)</br>
> [FC在线模拟器](https://game.moklgydocs.com/)</br>
> [爱国头像生成器](https://avatar.moklgydocs.com/)</br>
> [到账语音生成器](https://zfb.moklgydocs.com/)
