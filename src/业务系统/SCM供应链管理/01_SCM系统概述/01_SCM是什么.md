...
| 类别 | 代表产品 | 市场份额 | 备注 |
|------|---------|---------|------|
| 国际高端 | SAP IBP/SCM | 8% | 大型企业，SAP生态 |
| 国际专业 | Blue Yonder | 5% | AI驱动供应链优化 |
| 国际专业 | Kinaxis | 3% | 并发计划引擎，高科技行业 |
| 国产优化 | 杉数科技 | 4% | 国产运筹优化引擎 |
| 国产排程 | 悠桦林 | 3% | 国产高级排程 |
| ERP模块 | 用友/金蝶SCM模块 | 20% | ERP附带供应链功能 |
| 半手工 | 电话+微信+Excel | 57% | 计划靠经验，执行靠催促 |

### 典型痛点

- **供应链仍靠电话+微信驱动** — 计划靠经验、执行靠催促，缺料了打电话，催货了发微信，没有系统化流程
- **需求预测靠经验** — 没有统计模型，全凭老员工"感觉"，预测偏差大导致库存积压或频繁缺货
- **缺乏集成计划** — 销售、生产、采购各自为政，销售承诺交期不考虑产能，生产排程不关注物料齐套
- **供应链可见性低** — 无法看到2级以上供应商的状态，订单到了哪、在途多少全靠打电话问
- **库存与缺货并存** — 该有的没有，不该有的堆满仓库，库存周转率低但缺料停线频发

### 理想vs现实

| 维度 | 理想SCM | 国内常见现实 |
|------|---------|-------------|
| 需求预测 | 统计模型+AI预测，误差<15% | 凭经验估算，误差>40% |
| 计划协同 | S&OP统一计划，产销联动 | 销售、生产、采购各自排计划 |
| 供应可见 | 端到端可视，2级供应商状态可查 | 订单到了哪全靠打电话问 |
| 库存管理 | 基于服务水平的安全库存优化 | 经验备货，库存高但还缺料 |
| 执行协同 | 供应商门户在线协同 | 电话+微信+邮件催货 |

### 实用建议

1. 供应链数字化从需求预测开始 — 不准确的需求预测是万恶之源
2. S&OP（销售与运营计划）会议机制比系统更重要
3. 先打通ERP+SCM的数据流，再上高级计划算法
4. 库存优化是快速见效的切入点
5. 供应链可视化（订单追踪、在途状态）优先级高于高级算法
