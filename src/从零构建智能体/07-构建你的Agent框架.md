> 本文转载自 [Datawhale《从零开始构建智能体》(Hello-Agents)](https://hello-agents.datawhale.cc/),原文:<https://github.com/datawhalechina/hello-agents/blob/main/docs/chapter7/%E7%AC%AC%E4%B8%83%E7%AB%A0%20%E6%9E%84%E5%BB%BA%E4%BD%A0%E7%9A%84Agent%E6%A1%86%E6%9E%B6.md>。著作权归 Datawhale 社区所有,采用 [CC BY-NC-SA 4.0](https://creativecommons.org/licenses/by-nc-sa/4.0/deed.zh) 许可(署名-非商业性使用-相同方式共享),本站仅供个人学习使用。
...
<div align="center">
  ...
  <img src="/hello-agents/images/7-figures/table-01.png" alt="" width="90%"/>
</div>
...
<div align="center">
  ...
  <img src="/hello-agents/images/7-figures/table-02.png" alt="" width="90%"/>
</div>
...
<div align="center">
  <img src="/hello-agents/images/7-figures/01.png" alt="" width="90%"/>
...
1. 本章构建了 `HelloAgents` 框架，并阐述了"为何需要自建Agent框架"。请分析：
   ...
   - 在7.1.1节中提到了当前主流框架的四个主要局限性。结合你在[第六章习题](./06-框架开发实践.md#习题)或实际项目中使用过的某个框架的实际经验，说明这些问题是如何影响开发效率的。
