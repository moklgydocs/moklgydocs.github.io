> 本文转载自 [Datawhale《从零开始构建智能体》(Hello-Agents)](https://hello-agents.datawhale.cc/),原文:<https://github.com/datawhalechina/hello-agents/blob/main/Extra-Chapter/Extra04-DatawhaleFAQ.md>。著作权归 Datawhale 社区所有,采用 [CC BY-NC-SA 4.0](https://creativecommons.org/licenses/by-nc-sa/4.0/deed.zh) 许可(署名-非商业性使用-相同方式共享),本站仅供个人学习使用。
...
- 要点整理：
  ...
  - modelscope社区的模型api获取方法 https://www.modelscope.cn/models/Qwen/Qwen3-VL-8B-Instruct
    ...
    - ![alt text](/hello-agents/extra-images/Extra04-figures/3f1b68eedc9d9e556fbb51358bf49f9d.png)
    - ![alt text](/hello-agents/extra-images/Extra04-figures/e7dd177f-4867-4af0-bd0e-03771a3a040e.png)
