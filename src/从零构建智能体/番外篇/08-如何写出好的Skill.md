> 本文转载自 [Datawhale《从零开始构建智能体》(Hello-Agents)](https://hello-agents.datawhale.cc/),原文:<https://github.com/datawhalechina/hello-agents/blob/main/Extra-Chapter/Extra08-%E5%A6%82%E4%BD%95%E5%86%99%E5%87%BA%E5%A5%BD%E7%9A%84Skill.md>。著作权归 Datawhale 社区所有,采用 [CC BY-NC-SA 4.0](https://creativecommons.org/licenses/by-nc-sa/4.0/deed.zh) 许可(署名-非商业性使用-相同方式共享),本站仅供个人学习使用。
...
![目录](/hello-agents/extra-images/Extra08-figures/toc.png)
...
![Skill 标准结构与三级加载](/hello-agents/extra-images/Extra08-figures/skill-structure.png)
...
![自由度光谱](/hello-agents/extra-images/Extra08-figures/freedom-spectrum.png)
...
![六步创建流程](/hello-agents/extra-images/Extra08-figures/creation-flow.png)

理解→规划→初始化→编辑→校验→迭代。其中脚本贯穿流程，形成确定性的质量保障链：

![文件交互关系](/hello-agents/extra-images/Extra08-figures/file-interaction.png)
