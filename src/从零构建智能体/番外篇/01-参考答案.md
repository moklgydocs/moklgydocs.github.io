> 本文转载自 [Datawhale《从零开始构建智能体》(Hello-Agents)](https://hello-agents.datawhale.cc/),原文:<https://github.com/datawhalechina/hello-agents/blob/main/Extra-Chapter/Extra01-%E5%8F%82%E8%80%83%E7%AD%94%E6%A1%88.md>。著作权归 Datawhale 社区所有,采用 [CC BY-NC-SA 4.0](https://creativecommons.org/licenses/by-nc-sa/4.0/deed.zh) 许可(署名-非商业性使用-相同方式共享),本站仅供个人学习使用。
