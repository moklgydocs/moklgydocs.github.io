...
class RouterAgent:
    ...
    def route(self, state: CustomerServiceState) -> dict:
        """分析用户意图并路由"""
...
class FAQAgent:
    ...
    def answer(self, state: CustomerServiceState) -> dict:
        """检索知识库并生成回答"""
...
{context}"""},
        ...
        # 检测是否需要转人工
        needs_human = "转接人工" in answer or "人工客服" in answer
...
class BusinessAgent:
    ...
    def handle(self, state: CustomerServiceState) -> dict:
        """处理业务请求"""
...
class EscalationAgent:
    ...
    def escalate(self, state: CustomerServiceState) -> dict:
        """创建工单并转接人工"""
        conversation_summary = self._summarize(state)
    ...
    def _summarize(self, state: CustomerServiceState) -> str:
        """总结对话"""
