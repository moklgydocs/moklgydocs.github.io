...
http {
    ...
    map $request_id $log_sample_1pct {
        "~^0[0-9a-f]" 1;  # 首位0且第二位任意 → 1/16 × 1/16 ≈ 0.4%
        default 0;
    }
...
### 9.3 OpenTelemetry 模块（Nginx 1.25.2+）
...
opentelemetry_service_namespace "web";
opentelemetry_resource_attributes "service.version=1.0.0";
