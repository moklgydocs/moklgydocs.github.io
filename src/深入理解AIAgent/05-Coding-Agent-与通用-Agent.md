> 本文转载自 李博杰[《深入理解 AI Agent:设计原理与工程实践》](https://bojieli.github.io/ai-agent-book/),原文:<https://github.com/bojieli/ai-agent-book/blob/main/book/chapter5.md>。著作权归原作者所有,采用 [Apache License 2.0](https://github.com/bojieli/ai-agent-book/blob/main/LICENSE) 许可,本站按许可证要求保留版权声明(仅做格式适配与图片本地化),仅供个人学习使用。
...
![图5-1 OpenClaw 架构中的 Coding Agent 核心](/ai-agent-book/images/fig5-1.svg)
...
![图5-2 Coding Agent 工作流程](/ai-agent-book/images/fig5-2.svg)
...
![图5-3 Coding Agent 搜索工具对比](/ai-agent-book/images/fig5-3.svg)
...
![图5-4 五种文件编辑方案对比](/ai-agent-book/images/fig5-4.svg)
...
![图5-5 PPT 生成的提议者-审核者机制](/ai-agent-book/images/fig5-5.svg)
...
>
>
> ![图5-6 论文到讲解视频的端到端流水线](/ai-agent-book/images/fig5-6.svg)
>
>
...
>
>
> ![图5-7 生产日志智能诊断流水线](/ai-agent-book/images/fig5-7.svg)
>
>
...
![图5-8 动态表单生成流程](/ai-agent-book/images/fig5-8.svg)
...
![图5-9 SQL 查询 Agent 流程](/ai-agent-book/images/fig5-9.svg)
...
![图5-10 Agent 自举循环](/ai-agent-book/images/fig5-10.svg)
...
>
>
> ![图5-11 能创造 Agent 的 Agent 流水线](/ai-agent-book/images/fig5-11.svg)
>
