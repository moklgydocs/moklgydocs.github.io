> 本文转载自 李博杰[《深入理解 AI Agent:设计原理与工程实践》](https://bojieli.github.io/ai-agent-book/),原文:<https://github.com/bojieli/ai-agent-book/blob/main/book/chapter10.md>。著作权归原作者所有,采用 [Apache License 2.0](https://github.com/bojieli/ai-agent-book/blob/main/LICENSE) 许可,本站按许可证要求保留版权声明(仅做格式适配与图片本地化),仅供个人学习使用。
...
![图10-1 共享上下文与不共享上下文对比](/ai-agent-book/images/fig10-1.svg)
...
![图10-2 Agent 虚拟文件系统的四类区域挂载结构](/ai-agent-book/images/fig10-2.svg)
...
![图10-3 提议者-审核者循环](/ai-agent-book/images/fig10-3.svg)
...
![图10-4 Manager 顺序协调](/ai-agent-book/images/fig10-4.svg)
...
>
>
> ![图10-5 书籍翻译 Agent 架构](/ai-agent-book/images/fig10-5.svg)
>
>
...
![图10-6 Manager 并行协调](/ai-agent-book/images/fig10-6.svg)
...
>
>
> ![图10-7 Phone 与 Computer 双 Agent 架构](/ai-agent-book/images/fig10-7.svg)
...
>
>
> ![图10-8 并行 Web Scraping 架构](/ai-agent-book/images/fig10-8.svg)
>
>
...
![图10-9 MetaGPT 多 Agent 协作网络](/ai-agent-book/images/fig10-9.svg)
...
![图10-10 AI 小镇架构](/ai-agent-book/images/fig10-10.svg)
...
>
>
> ![图10-11 语音狼人杀 Agent 系统](/ai-agent-book/images/fig10-11.svg)
>
>
