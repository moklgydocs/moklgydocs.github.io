> 本文转载自 李博杰[《深入理解 AI Agent:设计原理与工程实践》](https://bojieli.github.io/ai-agent-book/),原文:<https://github.com/bojieli/ai-agent-book/blob/main/book/chapter9.md>。著作权归原作者所有,采用 [Apache License 2.0](https://github.com/bojieli/ai-agent-book/blob/main/LICENSE) 许可,本站按许可证要求保留版权声明(仅做格式适配与图片本地化),仅供个人学习使用。
...
![图9-1 Agent 持续进化的总体闭环](/ai-agent-book/images/fig9-1.svg)
...
![图9-2 从环境结果到 LLM Rubric 的三层轨迹验证](/ai-agent-book/images/fig9-2.svg)
...
![图9-3 持续进化的四种更新方式](/ai-agent-book/images/fig9-3.svg)
...
![图9-4 从已评价轨迹到经验知识文档](/ai-agent-book/images/fig9-4.svg)
...
![图9-5 在线执行与离线进化的双循环](/ai-agent-book/images/fig9-5.svg)
