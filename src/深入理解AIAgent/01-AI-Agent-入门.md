> 本文转载自 李博杰[《深入理解 AI Agent:设计原理与工程实践》](https://bojieli.github.io/ai-agent-book/),原文:<https://github.com/bojieli/ai-agent-book/blob/main/book/chapter1.md>。著作权归原作者所有,采用 [Apache License 2.0](https://github.com/bojieli/ai-agent-book/blob/main/LICENSE) 许可,本站按许可证要求保留版权声明(仅做格式适配与图片本地化),仅供个人学习使用。
...
![图1-1 Agent 与 Environment 的闭环交互，以及 Agent 内部的 Model–Harness 结构](/ai-agent-book/images/fig1-1.svg)
...
![图1-2 Agent 能力更新的三个层次](/ai-agent-book/images/fig1-2.svg)
...
>
> ![图1-3 实验 1-1——上下文消融实验设计](/ai-agent-book/images/fig1-3.svg)
>
...
![图1-4 Agent 轨迹——多币种汇总任务的 ReAct 循环](/ai-agent-book/images/fig1-4.svg)
...
>
> ![图1-5 “模型即 Agent” 架构——原生工具调用](/ai-agent-book/images/fig1-5.svg)
...
![图1-6 自主 Agent 的执行循环](/ai-agent-book/images/fig1-6.svg)
...
![图1-7 n8n 工作流编辑器界面](/ai-agent-book/images/n8n-workflow.png)
