> 本文转载自 李博杰[《深入理解 AI Agent:设计原理与工程实践》](https://bojieli.github.io/ai-agent-book/),原文:<https://github.com/bojieli/ai-agent-book/blob/main/book/chapter7.md>。著作权归原作者所有,采用 [Apache License 2.0](https://github.com/bojieli/ai-agent-book/blob/main/LICENSE) 许可,本站按许可证要求保留版权声明(仅做格式适配与图片本地化),仅供个人学习使用。
...
![图7-1 评估体系的三个层次](/ai-agent-book/images/fig7-1.svg)
...
![图7-2 工具调用型与人机交互型评估环境](/ai-agent-book/images/fig7-2.svg)
...
>
> ![图7-3 τ²-bench 评估架构](/ai-agent-book/images/fig7-3.svg)
>
...
![图7-4 LLM-as-a-Judge 流水线](/ai-agent-book/images/fig7-4.svg)
...
![图7-5 Elo 评分与配对比较排名](/ai-agent-book/images/fig7-5.svg)
...
![图7-6 可观测性技术栈](/ai-agent-book/images/fig7-6.svg)
...
![图7-7 Benchmark 到改进闭环](/ai-agent-book/images/fig7-7.svg)
...
![图7-8 仿真保真度谱](/ai-agent-book/images/fig7-8.svg)
...
>
>
> ![图7-9 OpenVLA 与 RoboTwin2 具身智能环境](/ai-agent-book/images/fig7-9.svg)
>
>
