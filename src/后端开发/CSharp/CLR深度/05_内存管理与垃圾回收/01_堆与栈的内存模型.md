...
{
    Console.WriteLine($"栈大小: {Thread.GetCurrentProcessorId()}");
...
IL_0010: ldloc.0
IL_0011: ldloc.2
IL_0012: callvirt instance void class [mscorlib]System.Collections.Generic.List`1<object>::Add(!0)
```

`newobj` 指令的执行流程：
1. 计算 `Object` 的大小（12 字节 x64，8 字节 x86 + 同步块）
...
{
    IL_0000: ldarg.0
    IL_0001: call native int [mscorlib]System.Runtime.InteropServices.Marshal::AllocHGlobal(intptr)
    IL_0006: ret
}
