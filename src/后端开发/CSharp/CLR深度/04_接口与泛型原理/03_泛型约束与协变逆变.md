...
```il
// 无约束版本的 IL
.method public hidebysig instance void Process<T>(!!T item) cil managed
{
...
.method public hidebysig instance void Process<
    (class [System.Runtime]System.IComparable`1<!!T>) T
>(!!T item) cil managed
{
    IL_0000: ldarg.1
    IL_0001: constrained. !!T             // 避免值类型装箱
    IL_0007: callvirt instance int32 class [System.Runtime]System.IComparable`1<!!T>::CompareTo(!0)
    IL_000c: pop
    IL_000d: ret
}
```
...
```il
.class public auto ansi beforefieldinit ConstraintDemo`2<
    (class [System.Runtime]System.IComparable`1<!0>,
     class [System.Runtime]System.ICloneable) T,
    (class [System.Runtime]System.EventArgs) K
>
    extends [System.Runtime]System.Object
{
    .method public hidebysig instance void Process(
        !0 item, !1 args) cil managed
    {
        IL_0000: nop
        IL_0001: ret
    }
...
注意 IL 中的约束语法：约束放在类声明的泛型参数 `<>` 内，以 `(constraint1, constraint2)` 的形式列出。类型级别泛型参数使用 `!0`、`!1` 引用，方法级别泛型参数使用 `!!0`、`!!1`。
...
.method public hidebysig static !!0 Max<
    (class [System.Runtime]System.IComparable`1<!!0>) T
>(!!0 a, !!0 b) cil managed
{
    IL_0000: ldarg.0
    IL_0001: constrained. !!0
    IL_0007: callvirt instance int32 class [System.Runtime]System.IComparable`1<!!0>::CompareTo(!0)
    IL_000c: ldc.i4.0
    IL_000d: cgt
...
```il
.method public hidebysig static valuetype [System.Runtime]System.Nullable`1<!!0> SafeParse<
    (valuetype .ctor) T
>(string s) cil managed
{
    ...
    .try
    {
        IL_0000: ldarg.0
        IL_0001: ldtoken !!0
        IL_0006: call class [System.Runtime]System.Type [System.Runtime]System.Type::GetTypeFromHandle(...)
        IL_000b: call object [System.Runtime]System.Convert::ChangeType(...)
        IL_0010: unbox.any !!0     // 拆箱
        IL_0015: newobj instance void valuetype [System.Runtime]System.Nullable`1<!!0>::.ctor(!0)
        IL_001a: ret
    }
    catch [System.Runtime]System.Exception
    {
        ...
        IL_001e: initobj valuetype [System.Runtime]System.Nullable`1<!!0>
...
.method public hidebysig static uint8* Allocate<
    (valuetype .ctor) T       // unmanaged 约束在 IL 中编码为 valuetype .ctor
    ...
    extends [System.Runtime]System.MulticastDelegate
{
    ...
    .method public hidebysig newslot virtual
        instance void EndInvoke(
            class [System.Runtime]System.IAsyncResult result) cil managed
}
```
...
demo.Process(list);  // 选择 Process(IEnumerable<string>) 重载
// 因为 IEnumerable<out T> 是协变的：
// List<string> → IEnumerable<string> ✓（精确匹配，更好转换目标）
// List<string> → IEnumerable<object> ✓（协变转换）
// C# 重载决议选择"更好的转换目标"，IEnumerable<string> 优于 IEnumerable<object>
```

::: warning 协变与重载设计的注意点
上例中 C# 重载决议有明确的"更好转换目标"规则，`IEnumerable<string>` 优于 `IEnumerable<object>`，因此不存在歧义。但当方法重载仅在泛型参数上不同且参数类型较复杂时，调用方可能难以预判实际调用的重载。最佳实践是避免这种重载设计，以提高代码可读性。
:::
...
### 11.4 .NET 9+ 的 allows ref struct 泛型约束

.NET 9（C# 13）引入了 `allows ref struct` 反向约束，允许泛型参数接受 ref struct：
...
.method public hidebysig static !!0 Sum<
    (class [System.Runtime]System.Numerics.IAdditionOperators`3<!!0, !!0, !!0>,
...
>(!!0[] values) cil managed
{
    ...
    IL_0009: ldloc.1
    IL_000a: ldelem !!0
    IL_000f: call !!0 class [System.Runtime]System.Numerics.IAdditionOperators`3<!!0, !!0, !!0>::op_Addition(!0, !0)
    IL_0014: stloc.0
    IL_0018: ldloc.2
    IL_0019: ldloc.1
...
>
{
    ...
    {
        IL_0000: ldtoken !0
        IL_0005: call class [System.Runtime]System.Type System.Type::GetTypeFromHandle(...)
        IL_000a: callvirt instance string [System.Runtime]System.Type::get_Name()
        IL_000f: ret
    }
...
// Func 的定义: Func<in T1, out TResult>
// T1 是逆变参数，所以 Func<object, string, int> → Func<string, string, int> 是合法的
// 因为传入 string 给期望 object 的参数总是安全的
Func<string, string, int> func2 = func1;  // 逆变转换合法
```
