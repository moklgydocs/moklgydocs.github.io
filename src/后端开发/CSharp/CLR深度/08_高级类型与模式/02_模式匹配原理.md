...
.method private hidebysig instance void TypePattern(object obj) cil managed
{
    ...
    IL_0001: isinst [mscorlib]System.String  // 类型检查
    IL_0006: dup                    // 复制结果
...
.method private hidebysig instance string StringSwitch(string value) cil managed
{
    ...
    // 计算字符串哈希值
    IL_0004: call instance int32 [mscorlib]System.String::GetHashCode()

    // 哈希值 switch
    IL_0009: switch (
        IL_0010,   // "apple".GetHashCode()
        IL_0020,   // "banana".GetHashCode()
        IL_0028    // "cherry".GetHashCode()
    )
