...
public class TypeHandleDemo
{
    public static void Main()
    {
        ...
        // 对象的第二个 8 字节就是这个地址
        // 在 64 位系统上:
        // obj + 0x00: SyncBlock 索引 (4 bytes, 高4字节保留)
        // obj + 0x08: TypeHandle (8 bytes) → 指向 MethodTable
        // obj + 0x10: 第一个实例字段
    }
}
```
...
sequenceDiagram
    ...
    Obj->>TH: 2. 读取 TypeHandle (偏移 +0x08)
...
IL_0000: ldloc.0
IL_0001: isinst [mscorlib]System.String    // 通过 TypeHandle 检查
IL_0006: ldnull
IL_0007: cgt.un                             // 不为 null 则为 true

// as 操作符的 IL —— 同样使用 isinst
IL_0000: ldloc.0
IL_0001: isinst [mscorlib]System.String    // 成功返回引用，失败返回 null
...
public class FalseSharingBenchmark
{
    ...
    public class CacheLinePadded
    {
        ...
        // 使用 StructLayout.Pad 或 Dummy 字段
