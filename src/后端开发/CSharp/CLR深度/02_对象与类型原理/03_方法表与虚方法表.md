...
头部:
  ...
  m_cbInstanceSize  = 40 (SyncBlock[8] + TypeHandle[8] + Owner[8] + padding[16])
  m_wNumMethods     = 7 (Speak + Name + Breed + Owner getter + Owner setter + .ctor)
  m_wNumVirtuals    = 6 (4 继承 + 2 新增)
