...
.method public hidebysig instance void Retry() cil managed
{
    ...
    IL_0015: ldc.i4.3           // ← MaxRetryCount = 3 直接嵌入！
    IL_0016: blt.s IL_0003      // i < 3
    IL_0018: ret
}
```
...
public readonly struct ReadOnlyStruct
{
    ...
    // public void Offset(int dx, int dy) { X += dx; Y += dy; } // CS1604
}
```
...
.type public auto ansi beforefieldinit LazyInit
       extends [mscorlib]System.Object
{
    // 有 beforefieldinit！
    // .cctor 可以更早调用
...
| 线程静态字段 | TLS（线程本地存储） | `ldthreadlocal` / `stthreadlocal` | 与线程相同 |
    ...
    GetByIndex(int32 index) cil managed
{
    ...
    IL_001a: ldarg.1
    IL_001b: ldelema [mscorlib]System.Int32    // ← 返回托管指针！
    IL_0020: stloc.0
