...
| `decimal` | System.Decimal | `valuetype [mscorlib]System.Decimal` | 16 | ±1.0×10^-28 ~ ±7.9×10^28 | ✅ |
...
.method public hidebysig static valuetype [mscorlib]System.Decimal
    Add(valuetype [mscorlib]System.Decimal a,
        valuetype [mscorlib]System.Decimal b) cil managed
{
    .maxstack 3
    IL_0000: ldarga.s a
    IL_0002: ldarga.s b
    IL_0004: call valuetype [mscorlib]System.Decimal
...
IL_0000: ldarg.0
IL_0001: callvirt instance int32 [mscorlib]System.Object::GetHashCode()
```
...
IL_0030: call string [mscorlib]System.String::Intern(string)
```
...
```il
// Nullable 值类型的 IL
.field public valuetype [mscorlib]System.Nullable`1<int32> NullableInt
...
IL_0004: call instance void valuetype
    [mscorlib]System.Nullable`1<int32>::.ctor(int32)
