...
```il
// typeof(string) 的 IL
IL_0001: ldtoken [System.Runtime]System.String
...
public class TypeHandleDemo
{
    public static void Main()
    {
        ...
        // 注意: RuntimeTypeHandle.Value 属性仅在 .NET Framework 中可用
        // .NET Core/.NET 5+ 中需通过反射或 unsafe 方式获取 MethodTable 指针
        // IntPtr methodTablePtr = handle.Value; // 仅 .NET Framework 可用
...
IL_0001: ldtoken [System.Runtime]System.String
IL_0006: call class [System.Runtime]System.Type [System.Runtime]System.Type::GetTypeFromHandle(valuetype [System.Runtime]System.RuntimeTypeHandle)
IL_000b: callvirt instance valuetype [System.Runtime]System.RuntimeTypeHandle [System.Runtime]System.Type::get_TypeHandle()
...
0x0C          m_wNumMethods             4 (.ctor + ToString + GetHashCode + CompareTo)
0x0E          m_wNumVirtuals            2 (ToString + GetHashCode)
...
--- 接口映射表 ---
0x30          IComparable\<Person\>       → CompareTo（隐式接口实现，非虚方法，通过接口映射调度）
...
```il
// 对应的 IL
IL_0000: ldtoken [System.Runtime]System.Collections.Generic.List`1<
...
public class MethodHandleDemo
{
    public static void Main()
    {
        ...
        // 从 Handle 获取方法信息
        // 注意: RuntimeMethodHandle.Value 属性仅在 .NET Framework 中可用
        // .NET Core/.NET 5+ 中需通过反射或 unsafe 方式获取 MethodDesc 指针
        // IntPtr methodDescPtr = handle.Value; // 仅 .NET Framework 可用
        Console.WriteLine($"MethodDesc 地址: 0x{methodDescPtr.ToString("X")}");

        // 通过 ldtoken 指令获取方法引用
        // 在 IL 中:
        // ldtoken method void [System.Runtime]System.String::Substring(int32)
        // call class [System.Runtime]System.Reflection.MethodBase
        //     [System.Runtime]System.Reflection.MethodBase::GetMethodFromHandle(
        //         valuetype [System.Runtime]System.RuntimeMethodHandle)
    }
}
```
...
IL_0001: ldtoken [System.Runtime]System.String
IL_0006: call class [System.Runtime]System.Type
    [System.Runtime]System.Type::GetTypeFromHandle(
        valuetype [System.Runtime]System.RuntimeTypeHandle)

// "hello".GetType() —— callvirt Object.GetType
IL_000b: ldstr "hello"
IL_0010: callvirt instance class [System.Runtime]System.Type
    [System.Runtime]System.Object::GetType()

// typeof(int) —— ldtoken + GetTypeFromHandle
IL_0015: ldtoken [System.Runtime]System.Int32
IL_001a: call class [System.Runtime]System.Type
    [System.Runtime]System.Type::GetTypeFromHandle(
        valuetype [System.Runtime]System.RuntimeTypeHandle)

// 42.GetType() —— 装箱 + callvirt
IL_001f: ldc.i4.s 42
IL_0021: box [System.Runtime]System.Int32       // ← 装箱！
IL_0026: callvirt instance class [System.Runtime]System.Type
    [System.Runtime]System.Object::GetType()
```
...
// typeof(T) 在开放泛型中的表示:
IL_0001: ldtoken !T           // !T 表示类型级别的泛型参数 T（!!T 为方法级别）
IL_0006: call class [System.Runtime]System.Type
    [System.Runtime]System.Type::GetTypeFromHandle(
        valuetype [System.Runtime]System.RuntimeTypeHandle)
...
.class public auto ansi beforefieldinit ConstraintDemo`1<
    (class [System.Runtime]System.IComparable`1<!!T>, .ctor) T>
       extends [System.Runtime]System.Object
{
