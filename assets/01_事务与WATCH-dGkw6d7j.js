...
<span class="line"><span>└──────────────┴──────────────────────┴──────────────────────┘</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_2-watch-乐观锁详解" tabindex="-1"><a class="header-anchor" href="#_2-watch-乐观锁详解"><span>2. WATCH 乐观锁详解</span></a></h2><h3 id="_2-1-watch-机制原理" tabindex="-1"><a class="header-anchor" href="#_2-1-watch-机制原理"><span>2.1 WATCH 机制原理</span></a></h3>`,14),r(d,{code:``}),o[1]||=t(`<h3 id="_2-2-watch-实现原理-cas" tabindex="-1"><a class="header-anchor" href="#_2-2-watch-实现原理-cas"><span>2.2 WATCH 实现原理（CAS）</span></a></h3><div class="language-text line-numbers-mode" data-highlighter="shiki" data-ext="text" style="background-color:#282c34;color:#abb2bf;"><pre class="shiki one-dark-pro vp-code"><code class="language-text"><span class="line"><span>WATCH 的底层实现 —— 乐观锁（Compare-And-Swap）：</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>  3. 如果 sha1 不存在，返回 NOSCRIPT 错误，需重新 EVAL</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_4-3-lua-执行流程" tabindex="-1"><a class="header-anchor" href="#_4-3-lua-执行流程"><span>4.3 Lua 执行流程</span></a></h3>`,18),r(d,{code:``}),o[2]||=t(`<h3 id="_4-4-lua-脚本中调用-redis" tabindex="-1"><a class="header-anchor" href="#_4-4-lua-脚本中调用-redis"><span>4.4 Lua 脚本中调用 Redis</span></a></h3><div class="language-lua line-numbers-mode" data-highlighter="shiki" data-ext="lua" style="background-color:#282c34;color:#abb2bf;"><pre class="shiki one-dark-pro vp-code"><code class="language-lua"><span class="line"><span style="color:#7F848E;font-style:italic;">-- Lua 脚本中调用 Redis 命令的两种方式</span></span>
<span class="line"></span>
