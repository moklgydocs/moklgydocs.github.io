import{M as e,O as t,c as n,d as r,h as i,m as a,p as o}from"./runtime-core.esm-bundler-jC72uHyJ.js";import{t as s}from"./app-CyWxe2cq.js";var c=JSON.parse(`{"path":"/%E8%AE%A1%E7%AE%97%E6%9C%BA%E5%AD%A6%E7%A7%91/%E6%B1%87%E7%BC%96%E8%AF%AD%E8%A8%80/04_%E4%BD%8D%E6%93%8D%E4%BD%9C%E4%B8%8E%E9%AB%98%E7%BA%A7%E8%BF%90%E7%AE%97/02_%E5%AD%97%E7%AC%A6%E4%B8%B2%E5%A4%84%E7%90%86.html","title":"字符串处理","lang":"zh-CN","frontmatter":{"title":"字符串处理","icon":"fa6-solid:font","order":2,"category":["计算机学科","汇编语言"],"tag":["字符串"]},"git":{"createdTime":1780564101000,"updatedTime":1780564101000,"contributors":[{"name":"jackie.liu","username":"","email":"moklgy@foxmail.com","commits":1}]},"readingTime":{"minutes":5.82,"words":1747},"filePathRelative":"计算机学科/汇编语言/04_位操作与高级运算/02_字符串处理.md"}`),l={name:`02_字符串处理.md`};function u(s,c,l,u,d,f){let p=e(`Mermaid`);return t(),r(`div`,null,[c[0]||=n(`h1`,{id:`字符串处理`,tabindex:`-1`},[n(`a`,{class:`header-anchor`,href:`#字符串处理`},[n(`span`,null,`字符串处理`)])],-1),c[1]||=n(`h2`,{id:`x86-字符串指令-硬件加速的数据搬运`,tabindex:`-1`},[n(`a`,{class:`header-anchor`,href:`#x86-字符串指令-硬件加速的数据搬运`},[n(`span`,null,`x86 字符串指令：硬件加速的数据搬运`)])],-1),c[2]||=n(`p`,null,[a(`x86 架构有一组专门的"字符串指令"，它们能自动递增/递减地址指针，配合 REP 前缀可以用一条指令完成整块数据的操作。这里的"字符串"不仅指文本——本质上它是`),n(`strong`,null,`内存块操作指令`),a(`。`)],-1),i(p,{code:``}),c[3]||=o(`<h2 id="方向标志-df" tabindex="-1"><a class="header-anchor" href="#方向标志-df"><span>方向标志 DF</span></a></h2><p>字符串指令的操作方向由 DF（Direction Flag）控制：</p><div class="language-nasm line-numbers-mode" data-highlighter="shiki" data-ext="nasm" style="background-color:#282c34;color:#abb2bf;"><pre class="shiki one-dark-pro vp-code"><code class="language-nasm"><span class="line"><span>cld                    ; DF=0, ESI/EDI 递增（向前，默认推荐）</span></span>
<span class="line"><span>std                    ; DF=1, ESI/EDI 递减（向后）</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div></div></div>`,3),i(p,{code:`eJxLy8kvT85ILCpR8AniUgCC4tKk9KLEggwFZx8XhacTJj7t7H22YuHTPf1gWRBIySxKTS7JzM+DaQEBR8NoJddgT21tpVgFXV07BUejaKUnu/ue7O172rHh5eoZSrFgpal5Kai2BIdAbJnQh9OWIB+4oBPEFl1dqC1OEFuA5gNtAdqFZAsAK7tLNQ==`}),c[4]||=o(`<div class="hint-container important"><p class="hint-container-title">始终先设置 DF</p><p>DF 的值可能被之前的代码修改，使用字符串指令前<strong>务必</strong>先 <code>CLD</code> 或 <code>STD</code>。大多数情况用 <code>CLD</code>（向前）。</p></div><h2 id="lods-加载字符串" tabindex="-1"><a class="header-anchor" href="#lods-加载字符串"><span>LODS - 加载字符串</span></a></h2><p>从 ESI 指向的内存加载到累加器：</p><div class="language-nasm line-numbers-mode" data-highlighter="shiki" data-ext="nasm" style="background-color:#282c34;color:#abb2bf;"><pre class="shiki one-dark-pro vp-code"><code class="language-nasm"><span class="line"><span>lodsb                  ; AL = [ESI], ESI += 1 (或 -= 1)</span></span>
<span class="line"><span>lodsw                  ; AX = [ESI], ESI += 2</span></span>
<span class="line"><span>lodsd                  ; EAX = [ESI], ESI += 4</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,4),i(p,{code:`eJxLy8kvT85ILCpR8AniUgACX1ffaKWnba1P185QiHYN9oxVilXQ1bVTqPHxdwl2qlFw9IlWcvRRigUrBspHKwEJmBqlF+2rnnatUDi00VCpBiRrBJZWByoHAO3pIMw=`}),c[5]||=o(`<p>典型用途：逐字符处理字符串。</p><h2 id="stos-存储字符串" tabindex="-1"><a class="header-anchor" href="#stos-存储字符串"><span>STOS - 存储字符串</span></a></h2><p>将累加器的值存入 EDI 指向的内存：</p><div class="language-nasm line-numbers-mode" data-highlighter="shiki" data-ext="nasm" style="background-color:#282c34;color:#abb2bf;"><pre class="shiki one-dark-pro vp-code"><code class="language-nasm"><span class="line"><span>stosb                  ; [EDI] = AL, EDI += 1</span></span>
...
<span class="line"><span>movsd                  ; 4 字节复制</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,10),i(p,{code:`eJwrTi0sTc1LTnXJTEwvSszlUgCCgsSikszkzILEvBIF12BPhcRiEKXxbNcETUx5F4i8i6fG89nrni1ohyjxyy9JVcgvSy0C6dQBylop+PqHBTuBJYFCunZ2YMGnS3qfdmwzfLp2+ouuJkydViBCWxtdAqQTSAAlACFtPek=`}),c[6]||=o(`<h3 id="批量复制" tabindex="-1"><a class="header-anchor" href="#批量复制"><span>批量复制</span></a></h3><div class="language-nasm line-numbers-mode" data-highlighter="shiki" data-ext="nasm" style="background-color:#282c34;color:#abb2bf;"><pre class="shiki one-dark-pro vp-code"><code class="language-nasm"><span class="line"><span>; 复制 1024 字节从 src 到 dst</span></span>
