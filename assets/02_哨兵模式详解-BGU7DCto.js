import{D as e,f as t,j as n,m as r,s as i,u as a}from"./runtime-core.esm-bundler-D3eD_xTR.js";import{t as o}from"./app-CFwkHOc4.js";var s=JSON.parse(`{"path":"/%E5%90%8E%E7%AB%AF%E5%BC%80%E5%8F%91/Redis/04_%E5%A4%8D%E5%88%B6%E4%B8%8E%E9%AB%98%E5%8F%AF%E7%94%A8/02_%E5%93%A8%E5%85%B5%E6%A8%A1%E5%BC%8F%E8%AF%A6%E8%A7%A3.html","title":"哨兵模式详解","lang":"zh-CN","frontmatter":{"title":"哨兵模式详解","icon":"fa6-solid:shield-halved","order":2,"category":["Redis"],"tag":["哨兵","Sentinel","故障转移","Raft","高可用"]},"git":{"createdTime":1780586585000,"updatedTime":1780712648000,"contributors":[{"name":"jackie.liu","username":"","email":"moklgy@foxmail.com","commits":2}]},"readingTime":{"minutes":27.77,"words":8331},"filePathRelative":"后端开发/Redis/04_复制与高可用/02_哨兵模式详解.md"}`),c={name:`02_哨兵模式详解.md`};function l(o,s,c,l,u,d){let f=n(`Mermaid`);return e(),a(`div`,null,[s[0]||=t(`<h1 id="哨兵模式详解" tabindex="-1"><a class="header-anchor" href="#哨兵模式详解"><span>哨兵模式详解</span></a></h1><blockquote><p>主从复制解决了数据冗余和读扩展的问题，但主节点仍然是单点 —— 一旦主节点宕机，整个集群失去写入能力，需要人工介入切换。Redis Sentinel（哨兵）就是那个&quot;自动值班员&quot;，它7×24小时监控主从节点，在主节点故障时自动完成故障转移，让高可用真正落地。</p></blockquote><h2 id="_1-为什么需要哨兵" tabindex="-1"><a class="header-anchor" href="#_1-为什么需要哨兵"><span>1. 为什么需要哨兵？</span></a></h2><h3 id="_1-1-主从复制的单点问题" tabindex="-1"><a class="header-anchor" href="#_1-1-主从复制的单点问题"><span>1.1 主从复制的单点问题</span></a></h3><div class="language-text line-numbers-mode" data-highlighter="shiki" data-ext="text" style="background-color:#282c34;color:#abb2bf;"><pre class="shiki one-dark-pro vp-code"><code class="language-text"><span class="line"><span>主从复制架构（无哨兵）：</span></span>
...
<span class="line"><span style="color:#7F848E;font-style:italic;">#       当前 Sentinel 将其标记为主观下线</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="hint-container tip"><p class="hint-container-title">down-after-milliseconds 的影响</p><p>这个值决定了故障检测的灵敏度：</p><ul><li><strong>太小</strong>（如 5 秒）：网络抖动就可能触发误判</li><li><strong>太大</strong>（如 120 秒）：故障检测太慢，影响可用性</li><li><strong>推荐</strong>：生产环境 10~30 秒</li></ul></div><h3 id="_3-3-客观下线-odown" tabindex="-1"><a class="header-anchor" href="#_3-3-客观下线-odown"><span>3.3 客观下线（ODOWN）</span></a></h3><p>客观下线是<strong>多个 Sentinel</strong> 对主节点的共识判断：</p>`,18),r(f,{code:``}),s[2]||=t(`<div class="language-bash line-numbers-mode" data-highlighter="shiki" data-ext="bash" style="background-color:#282c34;color:#abb2bf;"><pre class="shiki one-dark-pro vp-code"><code class="language-bash"><span class="line"><span style="color:#7F848E;font-style:italic;"># sentinel.conf 配置</span></span>
...
<span class="line"><span>3. 必要时执行 SENTINEL reset</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_14-sentinel-的工作流程总结" tabindex="-1"><a class="header-anchor" href="#_14-sentinel-的工作流程总结"><span>14. Sentinel 的工作流程总结</span></a></h2><h3 id="_14-1-正常运行流程" tabindex="-1"><a class="header-anchor" href="#_14-1-正常运行流程"><span>14.1 正常运行流程</span></a></h3>`,93),r(f,{code:``}),s[7]||=t(`<h3 id="_14-2-故障转移后的状态变化" tabindex="-1"><a class="header-anchor" href="#_14-2-故障转移后的状态变化"><span>14.2 故障转移后的状态变化</span></a></h3><div class="language-text line-numbers-mode" data-highlighter="shiki" data-ext="text" style="background-color:#282c34;color:#abb2bf;"><pre class="shiki one-dark-pro vp-code"><code class="language-text"><span class="line"><span>故障转移前：</span></span>
