import{A as e,E as t,d as n,l as r,p as i}from"./runtime-core.esm-bundler-tCF-J6l5.js";import{t as a}from"./app-BDkXanxw.js";var o=JSON.parse(`{"path":"/Linux/07_Nginx/07_%E7%BC%93%E5%AD%98%E4%B8%8E%E6%80%A7%E8%83%BD%E4%BC%98%E5%8C%96/04_%E6%80%A7%E8%83%BD%E8%B0%83%E4%BC%98%E6%A0%B8%E5%BF%83%E5%8F%82%E6%95%B0.html","title":"性能调优核心参数","lang":"zh-CN","frontmatter":{"title":"性能调优核心参数","icon":"fa6-solid:gauge-high","order":4,"category":["Linux","Nginx"],"tag":["Nginx","性能调优","worker_processes","worker_connections","Buffer","超时","Benchmark"]},"git":{"createdTime":1780631738000,"updatedTime":1780632863000,"contributors":[{"name":"jackie.liu","username":"","email":"moklgy@foxmail.com","commits":2}]},"readingTime":{"minutes":14.74,"words":4423},"filePathRelative":"Linux/07_Nginx/07_缓存与性能优化/04_性能调优核心参数.md"}`),s={name:`04_性能调优核心参数.md`};function c(a,o,s,c,l,u){let d=e(`Mermaid`);return t(),r(`div`,null,[o[0]||=n(`<h1 id="性能调优核心参数" tabindex="-1"><a class="header-anchor" href="#性能调优核心参数"><span>性能调优核心参数</span></a></h1><p>Nginx 以高性能著称，但默认配置并非为所有场景最优。在高并发、大流量、特殊业务需求下，需要根据硬件资源和应用特征调优核心参数。本文从 Worker 进程模型、连接数、缓冲区、超时、限制等维度，系统讲解 Nginx 性能调优的每一个关键参数。</p><h2 id="_1-worker-processes-进程数配置" tabindex="-1"><a class="header-anchor" href="#_1-worker-processes-进程数配置"><span>1. worker_processes：进程数配置</span></a></h2><h3 id="_1-1-worker-进程模型" tabindex="-1"><a class="header-anchor" href="#_1-1-worker-进程模型"><span>1.1 Worker 进程模型</span></a></h3><p>Nginx 采用多进程架构，一个 Master 进程管理多个 Worker 进程：</p>`,5),i(d,{code:``}),o[1]||=n(`<div class="language-nginx line-numbers-mode" data-highlighter="shiki" data-ext="nginx" style="background-color:#282c34;color:#abb2bf;"><pre class="shiki one-dark-pro vp-code"><code class="language-nginx"><span class="line"><span style="color:#7F848E;font-style:italic;"># nginx.conf main 上下文</span></span>
...
<span class="line"><span style="color:#C678DD;">        listen </span><span style="color:#D19A66;">80</span><span style="color:#ABB2BF;">;</span></span>
<span class="line"><span style="color:#ABB2BF;">    }</span></span>
<span class="line"><span style="color:#ABB2BF;">}</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_8-性能调优检查清单" tabindex="-1"><a class="header-anchor" href="#_8-性能调优检查清单"><span>8. 性能调优检查清单</span></a></h2><h3 id="_8-1-调优决策树" tabindex="-1"><a class="header-anchor" href="#_8-1-调优决策树"><span>8.1 调优决策树</span></a></h3>`,45),i(d,{code:``}),o[3]||=n(`<h3 id="_8-2-生产级调优配置模板" tabindex="-1"><a class="header-anchor" href="#_8-2-生产级调优配置模板"><span>8.2 生产级调优配置模板</span></a></h3><div class="language-nginx line-numbers-mode" data-highlighter="shiki" data-ext="nginx" style="background-color:#282c34;color:#abb2bf;"><pre class="shiki one-dark-pro vp-code"><code class="language-nginx"><span class="line"><span style="color:#C678DD;">user </span><span style="color:#ABB2BF;">nginx;</span></span>
<span class="line"><span style="color:#C678DD;">worker_processes </span><span style="color:#ABB2BF;">auto;</span></span>
