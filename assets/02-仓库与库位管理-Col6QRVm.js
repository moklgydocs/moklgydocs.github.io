...
<span class="line"><span>  = Σ(各库区已使用库位) / Σ(各库区总库位) × 100%</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_4-2-容量预警" tabindex="-1"><a class="header-anchor" href="#_4-2-容量预警"><span>4.2 容量预警</span></a></h3><table><thead><tr><th>级别</th><th>利用率范围</th><th>动作</th></tr></thead><tbody><tr><td>正常</td><td>0 - 70%</td><td>无</td></tr><tr><td>预警</td><td>70% - 85%</td><td>系统提醒</td></tr><tr><td>警告</td><td>85% - 95%</td><td>限制新上架</td></tr><tr><td>满载</td><td>&gt; 95%</td><td>禁止上架</td></tr></tbody></table><h2 id="五、条码-rfid-集成" tabindex="-1"><a class="header-anchor" href="#五、条码-rfid-集成"><span>五、条码/RFID 集成</span></a></h2><h3 id="_5-1-条码体系" tabindex="-1"><a class="header-anchor" href="#_5-1-条码体系"><span>5.1 条码体系</span></a></h3>`,26),t(`table`,null,[t(`thead`,null,[t(`tr`,null,[t(`th`,null,`对象`),t(`th`,null,`条码类型`),t(`th`,null,`格式`),t(`th`,null,`示例`)])]),t(`tbody`,null,[t(`tr`,null,[t(`td`,null,`库位`),t(`td`,null,`Code128`),t(`td`,{库位编码:``},`LOC-{仓库编码}-`),t(`td`,null,`LOC-RMWH-C010203`)]),t(`tr`,null,[t(`td`,null,`物料`),t(`td`,null,`Code128/EAN13`),t(`td`,{物料编码:``}),t(`td`,null,`MAT-20240001`)]),t(`tr`,null,[t(`td`,null,`批次`),t(`td`,null,`Code128`),t(`td`,{批次号:``},`BAT-{物料编码}-`),t(`td`,null,`BAT-MAT001-20240115`)]),t(`tr`,null,[t(`td`,null,`序列号`),t(`td`,null,`Code128`),t(`td`,{序列号:``},`SN-{物料编码}-`),t(`td`,null,`SN-MAT001-00001`)]),t(`tr`,null,[t(`td`,null,`入库单`),t(`td`,null,`QR Code`),t(`td`,{行号:``},`{入库单号}-`),t(`td`,null,`RO-20240115-0001-01`)]),t(`tr`,null,[t(`td`,null,`出库单`),t(`td`,null,`QR Code`),t(`td`,{行号:``},`{出库单号}-`),t(`td`,null,`IO-20240115-0001-01`)]),t(`tr`,null,[t(`td`,null,`托盘`),t(`td`,null,`Code128`),t(`td`,{SEQ:``},`PLT-{YYYYMMDD}-`),t(`td`,null,`PLT-20240115-0001`)])])],-1),r(`<h3 id="_5-2-手持终端操作" tabindex="-1"><a class="header-anchor" href="#_5-2-手持终端操作"><span>5.2 手持终端操作</span></a></h3><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" style="background-color:#282c34;color:#abb2bf;"><pre class="shiki one-dark-pro vp-code"><code class="language-"><span class="line"><span>扫描工作流:</span></span>
<span class="line"><span></span></span>
