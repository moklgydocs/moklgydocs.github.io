import{A as e,E as t,d as n,f as r,l as i,p as a,s as o}from"./runtime-core.esm-bundler-tCF-J6l5.js";import{t as s}from"./app-BaBfingU.js";var c=JSON.parse(`{"path":"/Linux/04_%E4%B8%89%E5%89%91%E5%AE%A2/03_awk%E7%BC%96%E7%A8%8B%E8%AF%AD%E8%A8%80.html","title":"awk 编程语言","lang":"zh-CN","frontmatter":{"title":"awk 编程语言","icon":"fa6-solid:code","order":3,"category":["Linux三剑客"],"tag":["awk","文本处理","编程语言","报表生成","数据ETL"]},"git":{"createdTime":1780586585000,"updatedTime":1780586585000,"contributors":[{"name":"jackie.liu","username":"","email":"moklgy@foxmail.com","commits":1}]},"readingTime":{"minutes":21.38,"words":6413},"filePathRelative":"Linux/04_三剑客/03_awk编程语言.md"}`),l={name:`03_awk编程语言.md`};function u(s,c,l,u,d,f){let p=e(`Mermaid`);return t(),i(`div`,null,[c[0]||=n(`<h1 id="awk-编程语言" tabindex="-1"><a class="header-anchor" href="#awk-编程语言"><span>awk 编程语言</span></a></h1><p>awk 不仅是文本处理工具，更是一门完整的编程语言——它由 Aho、Weinberger、Kernighan 三位 Unix 先驱于 1977 年设计，名字即取自三人首字母。awk 拥有变量、数组、函数、流程控制，能完成从简单字段提取到复杂数据报表的一切任务。本文从 awk 执行模型出发，逐步深入到高级编程特性。</p><h2 id="_1-awk-工作原理" tabindex="-1"><a class="header-anchor" href="#_1-awk-工作原理"><span>1. awk 工作原理</span></a></h2><h3 id="_1-1-执行模型" tabindex="-1"><a class="header-anchor" href="#_1-1-执行模型"><span>1.1 执行模型</span></a></h3><p>awk 程序的执行分为三个阶段：</p>`,5),a(p,{code:``}),c[1]||=n(`<div class="language-bash line-numbers-mode" data-highlighter="shiki" data-ext="bash" style="background-color:#282c34;color:#abb2bf;"><pre class="shiki one-dark-pro vp-code"><code class="language-bash"><span class="line"><span style="color:#7F848E;font-style:italic;"># awk 程序结构</span></span>
