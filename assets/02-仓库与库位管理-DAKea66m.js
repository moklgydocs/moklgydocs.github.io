...
<span class="line"><span>  = Σ(各库区已使用库位) / Σ(各库区总库位) × 100%</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_4-2-容量预警" tabindex="-1"><a class="header-anchor" href="#_4-2-容量预警"><span>4.2 容量预警</span></a></h3><table><thead><tr><th>级别</th><th>利用率范围</th><th>动作</th></tr></thead><tbody><tr><td>正常</td><td>0 - 70%</td><td>无</td></tr><tr><td>预警</td><td>70% - 85%</td><td>系统提醒</td></tr><tr><td>警告</td><td>85% - 95%</td><td>限制新上架</td></tr><tr><td>满载</td><td>&gt; 95%</td><td>禁止上架</td></tr></tbody></table><h2 id="五、条码-rfid-集成" tabindex="-1"><a class="header-anchor" href="#五、条码-rfid-集成"><span>五、条码/RFID 集成</span></a></h2><h3 id="_5-1-条码体系" tabindex="-1"><a class="header-anchor" href="#_5-1-条码体系"><span>5.1 条码体系</span></a></h3>`,26),n(`table`,null,[n(`thead`,null,[n(`tr`,null,[n(`th`,null,`对象`),n(`th`,null,`条码类型`),n(`th`,null,`格式`),n(`th`,null,`示例`)])]),n(`tbody`,null,[n(`tr`,null,[n(`td`,null,`库位`),n(`td`,null,`Code128`),n(`td`,{库位编码:``},`LOC-{仓库编码}-`),n(`td`,null,`LOC-RMWH-C010203`)]),n(`tr`,null,[n(`td`,null,`物料`),n(`td`,null,`Code128/EAN13`),n(`td`,{物料编码:``}),n(`td`,null,`MAT-20240001`)]),n(`tr`,null,[n(`td`,null,`批次`),n(`td`,null,`Code128`),n(`td`,{批次号:``},`BAT-{物料编码}-`),n(`td`,null,`BAT-MAT001-20240115`)]),n(`tr`,null,[n(`td`,null,`序列号`),n(`td`,null,`Code128`),n(`td`,{序列号:``},`SN-{物料编码}-`),n(`td`,null,`SN-MAT001-00001`)]),n(`tr`,null,[n(`td`,null,`入库单`),n(`td`,null,`QR Code`),n(`td`,{行号:``},`{入库单号}-`),n(`td`,null,`RO-20240115-0001-01`)]),n(`tr`,null,[n(`td`,null,`出库单`),n(`td`,null,`QR Code`),n(`td`,{行号:``},`{出库单号}-`),n(`td`,null,`IO-20240115-0001-01`)]),n(`tr`,null,[n(`td`,null,`托盘`),n(`td`,null,`Code128`),n(`td`,{SEQ:``},`PLT-{YYYYMMDD}-`),n(`td`,null,`PLT-20240115-0001`)])])],-1),t(`<h3 id="_5-2-手持终端操作" tabindex="-1"><a class="header-anchor" href="#_5-2-手持终端操作"><span>5.2 手持终端操作</span></a></h3><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" style="background-color:#282c34;color:#abb2bf;"><pre class="shiki one-dark-pro vp-code"><code class="language-"><span class="line"><span>扫描工作流:</span></span>
<span class="line"><span></span></span>
