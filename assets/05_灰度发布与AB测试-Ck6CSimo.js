import{D as e,f as t,j as n,m as r,u as i}from"./runtime-core.esm-bundler-D3eD_xTR.js";import{t as a}from"./app-BE_K1prB.js";var o=JSON.parse(`{"path":"/Linux/07_Nginx/06_%E9%99%90%E6%B5%81%E4%B8%8E%E8%AE%BF%E9%97%AE%E6%8E%A7%E5%88%B6/05_%E7%81%B0%E5%BA%A6%E5%8F%91%E5%B8%83%E4%B8%8EAB%E6%B5%8B%E8%AF%95.html","title":"灰度发布与 AB 测试","lang":"zh-CN","frontmatter":{"title":"灰度发布与 AB 测试","icon":"fa6-solid:flask-vial","order":5,"category":["Linux","Nginx"],"tag":["灰度发布","金丝雀发布","AB测试","split_clients","蓝绿部署","流量染色"]},"git":{"createdTime":1780631738000,"updatedTime":1780712648000,"contributors":[{"name":"jackie.liu","username":"","email":"moklgy@foxmail.com","commits":3}]},"readingTime":{"minutes":22.63,"words":6789},"filePathRelative":"Linux/07_Nginx/06_限流与访问控制/05_灰度发布与AB测试.md"}`),s={name:`05_灰度发布与AB测试.md`};function c(a,o,s,c,l,u){let d=n(`Mermaid`);return e(),i(`div`,null,[o[0]||=t(`<h1 id="灰度发布与-ab-测试" tabindex="-1"><a class="header-anchor" href="#灰度发布与-ab-测试"><span>灰度发布与 AB 测试</span></a></h1><p>灰度发布（又称金丝雀发布）和 AB 测试是现代软件交付中降低发布风险、验证功能效果的核心手段。Nginx 作为流量网关，能够基于请求特征将流量按比例路由到不同版本的后端服务，实现从 1% 到 100% 的渐进式发布。本文系统讲解 Nginx 灰度发布的完整方案，从基础的比例分流到全链路灰度，再到生产级灰度系统搭建。</p><hr><h2 id="_1-灰度发布概念与策略" tabindex="-1"><a class="header-anchor" href="#_1-灰度发布概念与策略"><span>1. 灰度发布概念与策略</span></a></h2><h3 id="_1-1-发布策略对比" tabindex="-1"><a class="header-anchor" href="#_1-1-发布策略对比"><span>1.1 发布策略对比</span></a></h3><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" style="background-color:#282c34;color:#abb2bf;"><pre class="shiki one-dark-pro vp-code"><code class="language-"><span class="line"><span>常见发布策略：</span></span>
...
<span class="line"><span style="color:#ABB2BF;">    }</span></span>
<span class="line"><span style="color:#ABB2BF;">}</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><hr><h2 id="_6-ab-测试实现" tabindex="-1"><a class="header-anchor" href="#_6-ab-测试实现"><span>6. AB 测试实现</span></a></h2><h3 id="_6-1-ab-测试架构" tabindex="-1"><a class="header-anchor" href="#_6-1-ab-测试架构"><span>6.1 AB 测试架构</span></a></h3>`,10),r(d,{code:``}),o[4]||=t(`<h3 id="_6-2-nginx-ab-测试配置" tabindex="-1"><a class="header-anchor" href="#_6-2-nginx-ab-测试配置"><span>6.2 Nginx AB 测试配置</span></a></h3><div class="language-nginx line-numbers-mode" data-highlighter="shiki" data-ext="nginx" style="background-color:#282c34;color:#abb2bf;"><pre class="shiki one-dark-pro vp-code"><code class="language-nginx"><span class="line"><span style="color:#7F848E;font-style:italic;"># AB 测试：多个变体并行</span></span>
<span class="line"></span>
