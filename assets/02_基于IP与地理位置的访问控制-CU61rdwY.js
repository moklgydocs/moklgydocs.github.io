...
<span class="line"><span style="color:#ABB2BF;">}</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="基于-ip-的访问控制流程" tabindex="-1"><a class="header-anchor" href="#基于-ip-的访问控制流程"><span>基于 IP 的访问控制流程</span></a></h3>`,17),i(d,{code:``}),o[1]||=n(`<hr><h2 id="geoip2-模块安装与配置" tabindex="-1"><a class="header-anchor" href="#geoip2-模块安装与配置"><span>GeoIP2 模块安装与配置</span></a></h2><h3 id="geoip2-简介" tabindex="-1"><a class="header-anchor" href="#geoip2-简介"><span>GeoIP2 简介</span></a></h3><p>GeoIP2 是 MaxMind 提供的 IP 地理位置数据库，可以根据 IP 地址查询国家、城市、时区、ISP 等信息。Nginx 通过 <code>ngx_http_geoip2_module</code> 模块支持 GeoIP2。</p><h3 id="安装-geoip2-模块" tabindex="-1"><a class="header-anchor" href="#安装-geoip2-模块"><span>安装 GeoIP2 模块</span></a></h3><div class="language-bash line-numbers-mode" data-highlighter="shiki" data-ext="bash" style="background-color:#282c34;color:#abb2bf;"><pre class="shiki one-dark-pro vp-code"><code class="language-bash"><span class="line"><span style="color:#7F848E;font-style:italic;"># 1. 下载 libmaxminddb 库</span></span>
...
<span class="line"><span style="color:#ABB2BF;">}</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="hint-container tip"><p class="hint-container-title">auto_reload</p><p><code>auto_reload</code> 参数控制 Nginx 多久检查一次数据库文件是否更新。设置合理的值可以在更新数据库后自动生效，无需重启 Nginx。</p></div><hr><h2 id="基于国家-城市的路由" tabindex="-1"><a class="header-anchor" href="#基于国家-城市的路由"><span>基于国家/城市的路由</span></a></h2><h3 id="基于国家代码的路由" tabindex="-1"><a class="header-anchor" href="#基于国家代码的路由"><span>基于国家代码的路由</span></a></h3>`,14),i(d,{code:``}),o[2]||=n(`<h3 id="国家路由配置" tabindex="-1"><a class="header-anchor" href="#国家路由配置"><span>国家路由配置</span></a></h3><div class="language-nginx line-numbers-mode" data-highlighter="shiki" data-ext="nginx" style="background-color:#282c34;color:#abb2bf;"><pre class="shiki one-dark-pro vp-code"><code class="language-nginx"><span class="line"><span style="color:#7F848E;font-style:italic;"># 使用 map 基于国家代码选择后端</span></span>
