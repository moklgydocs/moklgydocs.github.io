import{A as e,E as t,d as n,l as r,p as i}from"./runtime-core.esm-bundler-tCF-J6l5.js";import{t as a}from"./app-CyjyvRPH.js";var o=JSON.parse(`{"path":"/Linux/07_Nginx/06_%E9%99%90%E6%B5%81%E4%B8%8E%E8%AE%BF%E9%97%AE%E6%8E%A7%E5%88%B6/04_WAF%E4%B8%8E%E6%81%B6%E6%84%8F%E8%AF%B7%E6%B1%82%E9%98%B2%E6%8A%A4.html","title":"WAF 与恶意请求防护","lang":"zh-CN","frontmatter":{"title":"WAF 与恶意请求防护","icon":"fa6-solid:shield-virus","order":4,"category":["Linux","Nginx"],"tag":["WAF","ModSecurity","OWASP","SQL注入","XSS","DDoS","Bot检测"]},"git":{"createdTime":1780631738000,"updatedTime":1780632863000,"contributors":[{"name":"jackie.liu","username":"","email":"moklgy@foxmail.com","commits":2}]},"readingTime":{"minutes":29.79,"words":8937},"filePathRelative":"Linux/07_Nginx/06_限流与访问控制/04_WAF与恶意请求防护.md"}`),s={name:`04_WAF与恶意请求防护.md`};function c(a,o,s,c,l,u){let d=e(`Mermaid`);return t(),r(`div`,null,[o[0]||=n(`<h1 id="waf-与恶意请求防护" tabindex="-1"><a class="header-anchor" href="#waf-与恶意请求防护"><span>WAF 与恶意请求防护</span></a></h1><p>Web 应用防火墙（WAF）是 Nginx 安全体系的核心组件。与网络层防火墙不同，WAF 工作在应用层（OSI 第 7 层），能够深入解析 HTTP 请求内容，识别并拦截 SQL 注入、XSS 跨站脚本、文件包含、路径遍历等攻击。本文从 WAF 原理出发，系统讲解 ModSecurity 集成、OWASP CRS 规则集、常见攻击防护以及自定义规则编写。</p><hr><h2 id="_1-waf-原理与架构" tabindex="-1"><a class="header-anchor" href="#_1-waf-原理与架构"><span>1. WAF 原理与架构</span></a></h2><h3 id="_1-1-waf-在安全体系中的位置" tabindex="-1"><a class="header-anchor" href="#_1-1-waf-在安全体系中的位置"><span>1.1 WAF 在安全体系中的位置</span></a></h3>`,5),i(d,{code:``}),o[1]||=n(`<h3 id="_1-2-waf-工作模式" tabindex="-1"><a class="header-anchor" href="#_1-2-waf-工作模式"><span>1.2 WAF 工作模式</span></a></h3><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" style="background-color:#282c34;color:#abb2bf;"><pre class="shiki one-dark-pro vp-code"><code class="language-"><span class="line"><span>WAF 三种工作模式：</span></span>
...
<span class="line"><span style="color:#98C379;">     t:none,</span><span style="color:#56B6C2;">\\</span></span>
<span class="line"><span style="color:#98C379;">     nolog,</span><span style="color:#56B6C2;">\\</span></span>
<span class="line"><span style="color:#98C379;">     setvar:tx.crs_setup_version=400&quot;</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><hr><h2 id="_4-sql-注入防护" tabindex="-1"><a class="header-anchor" href="#_4-sql-注入防护"><span>4. SQL 注入防护</span></a></h2><h3 id="_4-1-sql-注入攻击类型与检测" tabindex="-1"><a class="header-anchor" href="#_4-1-sql-注入攻击类型与检测"><span>4.1 SQL 注入攻击类型与检测</span></a></h3>`,10),i(d,{code:``}),o[4]||=n(`<h3 id="_4-2-crs-sql-注入规则详解" tabindex="-1"><a class="header-anchor" href="#_4-2-crs-sql-注入规则详解"><span>4.2 CRS SQL 注入规则详解</span></a></h3><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" style="background-color:#282c34;color:#abb2bf;"><pre class="shiki one-dark-pro vp-code"><code class="language-"><span class="line"><span>CRS SQL 注入规则组 (942*):</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span style="color:#98C379;">     severity:&#39;</span><span style="color:#ABB2BF;">CRITICAL</span><span style="color:#98C379;">&#39;,\\</span></span>
<span class="line"><span style="color:#98C379;">     setvar:&#39;</span><span style="color:#ABB2BF;">tx.xss_score=+%{tx.critical_anomaly_score}</span><span style="color:#98C379;">&#39;,\\</span></span>
<span class="line"><span style="color:#98C379;">     setvar:&#39;</span><span style="color:#ABB2BF;">tx.inbound_anomaly_score=+%{tx.critical_anomaly_score}</span><span style="color:#98C379;">&#39;&quot;</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><hr><h2 id="_6-文件上传与路径遍历防护" tabindex="-1"><a class="header-anchor" href="#_6-文件上传与路径遍历防护"><span>6. 文件上传与路径遍历防护</span></a></h2><h3 id="_6-1-文件上传攻击防护" tabindex="-1"><a class="header-anchor" href="#_6-1-文件上传攻击防护"><span>6.1 文件上传攻击防护</span></a></h3>`,19),i(d,{code:``}),o[5]||=n(`<h3 id="_6-2-nginx-文件上传安全配置" tabindex="-1"><a class="header-anchor" href="#_6-2-nginx-文件上传安全配置"><span>6.2 Nginx 文件上传安全配置</span></a></h3><div class="language-nginx line-numbers-mode" data-highlighter="shiki" data-ext="nginx" style="background-color:#282c34;color:#abb2bf;"><pre class="shiki one-dark-pro vp-code"><code class="language-nginx"><span class="line"><span style="color:#C678DD;">server</span><span style="color:#ABB2BF;"> {</span></span>
<span class="line"><span style="color:#C678DD;">    listen </span><span style="color:#D19A66;">80</span><span style="color:#ABB2BF;">;</span></span>
...
<span class="line"><span style="color:#C678DD;">        proxy_pass </span><span style="color:#ABB2BF;">http://backend;</span></span>
<span class="line"><span style="color:#ABB2BF;">    }</span></span>
<span class="line"><span style="color:#ABB2BF;">}</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><hr><h2 id="_8-ddos-防护" tabindex="-1"><a class="header-anchor" href="#_8-ddos-防护"><span>8. DDoS 防护</span></a></h2><h3 id="_8-1-nginx-层面-ddos-防护架构" tabindex="-1"><a class="header-anchor" href="#_8-1-nginx-层面-ddos-防护架构"><span>8.1 Nginx 层面 DDoS 防护架构</span></a></h3>`,19),i(d,{code:``}),o[6]||=n(`<h3 id="_8-2-http-flood-防护" tabindex="-1"><a class="header-anchor" href="#_8-2-http-flood-防护"><span>8.2 HTTP Flood 防护</span></a></h3><div class="language-nginx line-numbers-mode" data-highlighter="shiki" data-ext="nginx" style="background-color:#282c34;color:#abb2bf;"><pre class="shiki one-dark-pro vp-code"><code class="language-nginx"><span class="line"><span style="color:#7F848E;font-style:italic;"># HTTP Flood 防护配置</span></span>
<span class="line"><span style="color:#C678DD;">http</span><span style="color:#ABB2BF;"> {</span></span>
...
<span class="line"><span style="color:#98C379;">     ver:&#39;</span><span style="color:#ABB2BF;">custom/1.0</span><span style="color:#98C379;">&#39;,\\</span></span>
<span class="line"><span style="color:#98C379;">     severity:&#39;</span><span style="color:#ABB2BF;">CRITICAL</span><span style="color:#98C379;">&#39;,\\</span></span>
<span class="line"><span style="color:#98C379;">     expirevar:ip.url_count=300&quot;</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><hr><h2 id="_10-waf-运维与调优" tabindex="-1"><a class="header-anchor" href="#_10-waf-运维与调优"><span>10. WAF 运维与调优</span></a></h2><h3 id="_10-1-误报处理流程" tabindex="-1"><a class="header-anchor" href="#_10-1-误报处理流程"><span>10.1 误报处理流程</span></a></h3>`,17),i(d,{code:``}),o[7]||=n(`<h3 id="_10-2-误报排除规则" tabindex="-1"><a class="header-anchor" href="#_10-2-误报排除规则"><span>10.2 误报排除规则</span></a></h3><div class="language-nginx line-numbers-mode" data-highlighter="shiki" data-ext="nginx" style="background-color:#282c34;color:#abb2bf;"><pre class="shiki one-dark-pro vp-code"><code class="language-nginx"><span class="line"><span style="color:#7F848E;font-style:italic;"># /etc/nginx/waf/exclusions.conf</span></span>
<span class="line"></span>
