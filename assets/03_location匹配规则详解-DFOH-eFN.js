...
<span class="line"><span style="color:#ABB2BF;">}</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="if-的执行机制" tabindex="-1"><a class="header-anchor" href="#if-的执行机制"><span>if 的执行机制</span></a></h3>`,50),r(f,{code:``}),s[5]||=t(`<h3 id="if-的安全用法" tabindex="-1"><a class="header-anchor" href="#if-的安全用法"><span>if 的安全用法</span></a></h3><p><code>if</code> 在以下场景中是安全的：</p><ol><li><strong>return</strong>：直接返回响应</li><li><strong>rewrite ... last/redirect/permanent</strong>：重写或重定向</li></ol><div class="language-nginx line-numbers-mode" data-highlighter="shiki" data-ext="nginx" style="background-color:#282c34;color:#abb2bf;"><pre class="shiki one-dark-pro vp-code"><code class="language-nginx"><span class="line"><span style="color:#7F848E;font-style:italic;"># 安全用法 1：return</span></span>
<span class="line"><span style="color:#C678DD;">location</span><span style="color:#ABB2BF;"> /api/ {</span></span>
