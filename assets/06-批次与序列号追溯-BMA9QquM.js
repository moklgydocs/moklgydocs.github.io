...
<span class="line"><span>            └──▶ Scrapped (报废)</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_1-3-批次编号规则" tabindex="-1"><a class="header-anchor" href="#_1-3-批次编号规则"><span>1.3 批次编号规则</span></a></h3>`,9),t(`table`,null,[t(`thead`,null,[t(`tr`,null,[t(`th`,null,`生成方式`),t(`th`,null,`格式`),t(`th`,null,`示例`),t(`th`,null,`适用场景`)])]),t(`tbody`,null,[t(`tr`,null,[t(`td`,null,`日期+序号`),t(`td`,{SEQ:``},`{YYYYMMDD}-`),t(`td`,null,`20240115-001`),t(`td`,null,`通用`)]),t(`tr`,null,[t(`td`,null,`供应商+日期`),t(`td`,{YYYYMMDD:``},`{SUP}-`),t(`td`,null,`S001-20240115`),t(`td`,null,`采购件`)]),t(`tr`,null,[t(`td`,null,`工单+序号`),t(`td`,{SEQ:``},`{WO}-`),t(`td`,null,`WO001-01`),t(`td`,null,`自制件`)]),t(`tr`,null,[t(`td`,null,`自定义`),t(`td`,null,`用户输入`),t(`td`,null,`任意`),t(`td`,null,`特殊需求`)])])],-1),r(`<h2 id="二、序列号管理" tabindex="-1"><a class="header-anchor" href="#二、序列号管理"><span>二、序列号管理</span></a></h2><h3 id="_2-1-序列号实体" tabindex="-1"><a class="header-anchor" href="#_2-1-序列号实体"><span>2.1 序列号实体</span></a></h3><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" style="background-color:#282c34;color:#abb2bf;"><pre class="shiki one-dark-pro vp-code"><code class="language-"><span class="line"><span>SerialNumber (序列号)</span></span>
<span class="line"><span>├── Id: Guid</span></span>
<span class="line"><span>├── TenantId: Guid</span></span>
<span class="line"><span>├── ItemId: Guid</span></span>
<span class="line"><span>├── ItemCode: string(50)</span></span>
