import{A as e,E as t,d as n,l as r,p as i}from"./runtime-core.esm-bundler-tCF-J6l5.js";import{t as a}from"./app-BDkXanxw.js";var o=JSON.parse(`{"path":"/Linux/07_Nginx/08_%E9%AB%98%E7%BA%A7%E7%89%B9%E6%80%A7%E4%B8%8E%E6%89%A9%E5%B1%95/02_Stream%E5%9B%9B%E5%B1%82%E4%BB%A3%E7%90%86%E4%B8%8E%E9%82%AE%E4%BB%B6%E4%BB%A3%E7%90%86.html","title":"Stream 四层代理与邮件代理","lang":"zh-CN","frontmatter":{"title":"Stream 四层代理与邮件代理","icon":"fa6-solid:water","order":2,"category":["Linux","Nginx"],"tag":["Nginx","Stream","TCP代理","UDP代理","四层代理","邮件代理","SNI路由"]},"git":{"createdTime":1780631738000,"updatedTime":1780632863000,"contributors":[{"name":"jackie.liu","username":"","email":"moklgy@foxmail.com","commits":2}]},"readingTime":{"minutes":9.96,"words":2988},"filePathRelative":"Linux/07_Nginx/08_高级特性与扩展/02_Stream四层代理与邮件代理.md"}`),s={name:`02_Stream四层代理与邮件代理.md`};function c(a,o,s,c,l,u){let d=e(`Mermaid`);return t(),r(`div`,null,[o[0]||=n(`<h1 id="stream-四层代理与邮件代理" tabindex="-1"><a class="header-anchor" href="#stream-四层代理与邮件代理"><span>Stream 四层代理与邮件代理</span></a></h1><p>Nginx 不仅是 HTTP 七层代理，还能在传输层（TCP/UDP）做四层代理。<code>ngx_stream_core_module</code> 让 Nginx 可以代理 MySQL、Redis、PostgreSQL、gRPC 等任何 TCP/UDP 协议，还可以做邮件代理。本文系统讲解 Stream 模块的配置、负载均衡、SSL/TLS 和实际应用场景。</p><h2 id="_1-stream-模块概述与配置" tabindex="-1"><a class="header-anchor" href="#_1-stream-模块概述与配置"><span>1. stream 模块概述与配置</span></a></h2><h3 id="_1-1-四层代理架构" tabindex="-1"><a class="header-anchor" href="#_1-1-四层代理架构"><span>1.1 四层代理架构</span></a></h3>`,4),i(d,{code:``}),o[1]||=n(`<h3 id="_1-2-stream-上下文" tabindex="-1"><a class="header-anchor" href="#_1-2-stream-上下文"><span>1.2 stream 上下文</span></a></h3><p><code>stream</code> 上下文与 <code>http</code> 上下文平级，在 <code>main</code> 上下文中定义：</p><div class="language-nginx line-numbers-mode" data-highlighter="shiki" data-ext="nginx" style="background-color:#282c34;color:#abb2bf;"><pre class="shiki one-dark-pro vp-code"><code class="language-nginx"><span class="line"><span style="color:#7F848E;font-style:italic;"># nginx.conf</span></span>
...
<span class="line"><span style="color:#C678DD;">        proxy_responses </span><span style="color:#D19A66;">1</span><span style="color:#ABB2BF;">;</span></span>
<span class="line"><span style="color:#ABB2BF;">    }</span></span>
<span class="line"><span style="color:#ABB2BF;">}</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_4-mysql-redis-代理实战" tabindex="-1"><a class="header-anchor" href="#_4-mysql-redis-代理实战"><span>4. MySQL/Redis 代理实战</span></a></h2><h3 id="_4-1-mysql-代理实战" tabindex="-1"><a class="header-anchor" href="#_4-1-mysql-代理实战"><span>4.1 MySQL 代理实战</span></a></h3>`,20),i(d,{code:``}),o[2]||=n(`<div class="language-nginx line-numbers-mode" data-highlighter="shiki" data-ext="nginx" style="background-color:#282c34;color:#abb2bf;"><pre class="shiki one-dark-pro vp-code"><code class="language-nginx"><span class="line"><span style="color:#C678DD;">stream</span><span style="color:#ABB2BF;"> {</span></span>
...
<span class="line"><span style="color:#ABB2BF;">    }</span></span>
<span class="line"><span style="color:#ABB2BF;">}</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_4-3-连接流程图" tabindex="-1"><a class="header-anchor" href="#_4-3-连接流程图"><span>4.3 连接流程图</span></a></h3>`,4),i(d,{code:``}),o[3]||=n(`<h2 id="_5-stream-ssl-tls-配置" tabindex="-1"><a class="header-anchor" href="#_5-stream-ssl-tls-配置"><span>5. stream SSL/TLS 配置</span></a></h2><h3 id="_5-1-ssl-终端" tabindex="-1"><a class="header-anchor" href="#_5-1-ssl-终端"><span>5.1 SSL 终端</span></a></h3><div class="language-nginx line-numbers-mode" data-highlighter="shiki" data-ext="nginx" style="background-color:#282c34;color:#abb2bf;"><pre class="shiki one-dark-pro vp-code"><code class="language-nginx"><span class="line"><span style="color:#C678DD;">stream</span><span style="color:#ABB2BF;"> {</span></span>
