import{A as e,E as t,d as n,f as r,l as i,p as a,s as o}from"./runtime-core.esm-bundler-tCF-J6l5.js";import{t as s}from"./app-DApykHxA.js";var c=JSON.parse(`{"path":"/Linux/04_%E4%B8%89%E5%89%91%E5%AE%A2/04_%E4%B8%89%E5%89%91%E5%AE%A2%E7%BB%BC%E5%90%88%E5%AE%9E%E6%88%98.html","title":"三剑客综合实战","lang":"zh-CN","frontmatter":{"title":"三剑客综合实战","icon":"fa6-solid:layer-group","order":4,"category":["Linux三剑客"],"tag":["grep","sed","awk","日志分析","数据处理","管道"]},"git":{"createdTime":1780586585000,"updatedTime":1780586585000,"contributors":[{"name":"jackie.liu","username":"","email":"moklgy@foxmail.com","commits":1}]},"readingTime":{"minutes":23.82,"words":7147},"filePathRelative":"Linux/04_三剑客/04_三剑客综合实战.md"}`),l={name:`04_三剑客综合实战.md`};function u(s,c,l,u,d,f){let p=e(`Mermaid`);return t(),i(`div`,null,[c[0]||=n(`<h1 id="三剑客综合实战" tabindex="-1"><a class="header-anchor" href="#三剑客综合实战"><span>三剑客综合实战</span></a></h1><p>grep 擅长搜索过滤，sed 擅长流式替换，awk 擅长字段计算——三者组合，构成 Linux 文本处理的&quot;万能瑞士军刀&quot;。本文从管道串联的基础模式出发，通过 Nginx 日志分析、系统安全审计、CSV 数据 ETL、文本报表等实战场景，展示三剑客的协作艺术。</p><h2 id="_1-三剑客协作原理" tabindex="-1"><a class="header-anchor" href="#_1-三剑客协作原理"><span>1. 三剑客协作原理</span></a></h2><h3 id="_1-1-各自的定位" tabindex="-1"><a class="header-anchor" href="#_1-1-各自的定位"><span>1.1 各自的定位</span></a></h3>`,4),a(p,{code:``}),c[1]||=n(`<table><thead><tr><th>工具</th><th>核心能力</th><th>不擅长的</th><th>类比</th></tr></thead><tbody><tr><td><strong>grep</strong></td><td>搜索、过滤、定位</td><td>修改内容、计算</td><td>放大镜</td></tr><tr><td><strong>sed</strong></td><td>替换、删除、插入、格式变换</td><td>字段计算、条件逻辑</td><td>橡皮擦+涂改液</td></tr><tr><td><strong>awk</strong></td><td>字段提取、计算统计、报表生成</td><td>简单替换（不如sed简洁）</td><td>计算器+打印机</td></tr></tbody></table><h3 id="_1-2-管道协作流水线" tabindex="-1"><a class="header-anchor" href="#_1-2-管道协作流水线"><span>1.2 管道协作流水线</span></a></h3>`,2),a(p,{code:``}),c[2]||=n(`<h3 id="_1-3-选择原则" tabindex="-1"><a class="header-anchor" href="#_1-3-选择原则"><span>1.3 选择原则</span></a></h3><div class="language-bash line-numbers-mode" data-highlighter="shiki" data-ext="bash" style="background-color:#282c34;color:#abb2bf;"><pre class="shiki one-dark-pro vp-code"><code class="language-bash"><span class="line"><span style="color:#7F848E;font-style:italic;"># 原则1：搜索过滤 → grep</span></span>
...
<span class="line"><span style="color:#98C379;">}&#39;</span><span style="color:#98C379;"> data.txt</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="小结" tabindex="-1"><a class="header-anchor" href="#小结"><span>小结</span></a></h2>`,12),a(p,{code:``}),c[6]||=o(`blockquote`,null,[o(`p`,null,[o(`strong`,null,`参考书目`)]),o(`ul`,null,[o(`li`,null,`《sed & awk 101 Hacks》—— Ramesh Natarajan`),o(`li`,null,`《AWK程序设计语言》—— Alfred V. Aho, Brian W. Kernighan, Peter J. Weinberger`),o(`li`,null,`《Linux命令行与Shell脚本编程大全》（第4版）—— Richard Blum, Christine Bresnahan`),o(`li`,null,[r(`Nginx 日志格式官方文档：`),o(`a`,{href:`https://nginx.org/en/docs/http/ngx_http_log_module.html`,target:`_blank`,rel:`noopener noreferrer`},`https://nginx.org/en/docs/http/ngx_http_log_module.html`)])])],-1)])}var d=s(l,[[`render`,u]]);export{c as _pageData,d as default};