import{A as e,E as t,d as n,l as r,p as i}from"./runtime-core.esm-bundler-tCF-J6l5.js";import{t as a}from"./app-BWBxR0Xs.js";var o=JSON.parse(`{"path":"/Linux/07_Nginx/01_Nginx%E5%9F%BA%E7%A1%80%E4%B8%8E%E6%9E%B6%E6%9E%84/02_Nginx%E5%AE%89%E8%A3%85%E4%B8%8E%E7%89%88%E6%9C%AC%E9%80%89%E5%9E%8B.html","title":"Nginx 安装与版本选型","lang":"zh-CN","frontmatter":{"title":"Nginx 安装与版本选型","icon":"fa6-solid:download","order":2,"category":["Linux","Nginx"],"tag":["Nginx","安装","编译","Docker","版本选型"]},"git":{"createdTime":1780631738000,"updatedTime":1780632863000,"contributors":[{"name":"jackie.liu","username":"","email":"moklgy@foxmail.com","commits":2}]},"readingTime":{"minutes":22.36,"words":6707},"filePathRelative":"Linux/07_Nginx/01_Nginx基础与架构/02_Nginx安装与版本选型.md"}`),s={name:`02_Nginx安装与版本选型.md`};function c(a,o,s,c,l,u){let d=e(`Mermaid`);return t(),r(`div`,null,[o[0]||=n(`<h1 id="nginx-安装与版本选型" tabindex="-1"><a class="header-anchor" href="#nginx-安装与版本选型"><span>Nginx 安装与版本选型</span></a></h1><h2 id="_1-安装方式概览" tabindex="-1"><a class="header-anchor" href="#_1-安装方式概览"><span>1. 安装方式概览</span></a></h2><p>Nginx 提供多种安装方式，各有优劣，选择合适的方式是部署的第一步：</p><table><thead><tr><th>安装方式</th><th>优点</th><th>缺点</th><th>适用场景</th></tr></thead><tbody><tr><td>包管理器（apt/yum）</td><td>简单快捷、自动更新</td><td>版本滞后、模块有限</td><td>开发/测试</td></tr><tr><td>官方仓库（<a href="http://nginx.org" target="_blank" rel="noopener noreferrer">nginx.org</a>）</td><td>版本较新、官方维护</td><td>模块仍有限</td><td>生产通用</td></tr><tr><td>源码编译</td><td>最大灵活性、可定制模块</td><td>维护成本高、升级复杂</td><td>生产高性能</td></tr><tr><td>Docker</td><td>环境一致、快速部署</td><td>性能略损、调试不便</td><td>容器化部署</td></tr><tr><td>第三方仓库（Ondřej等）</td><td>模块丰富、版本最新</td><td>非官方、稳定性待验证</td><td>开发尝鲜</td></tr></tbody></table>`,4),i(d,{code:``}),o[1]||=n(`<h2 id="_2-包管理器安装" tabindex="-1"><a class="header-anchor" href="#_2-包管理器安装"><span>2. 包管理器安装</span></a></h2><h3 id="_2-1-ubuntu-debian-系-apt" tabindex="-1"><a class="header-anchor" href="#_2-1-ubuntu-debian-系-apt"><span>2.1 Ubuntu/Debian 系（apt）</span></a></h3><h4 id="默认仓库安装" tabindex="-1"><a class="header-anchor" href="#默认仓库安装"><span>默认仓库安装</span></a></h4><p>Ubuntu 默认仓库中的 Nginx 版本通常较旧：</p><div class="language-bash line-numbers-mode" data-highlighter="shiki" data-ext="bash" style="background-color:#282c34;color:#abb2bf;"><pre class="shiki one-dark-pro vp-code"><code class="language-bash"><span class="line"><span style="color:#7F848E;font-style:italic;"># 更新包索引</span></span>
...
<span class="line"><span style="color:#61AFEF;">sudo</span><span style="color:#98C379;"> systemctl</span><span style="color:#98C379;"> is-enabled</span><span style="color:#98C379;"> nginx</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_3-源码编译安装" tabindex="-1"><a class="header-anchor" href="#_3-源码编译安装"><span>3. 源码编译安装</span></a></h2><h3 id="_3-1-编译安装完整流程" tabindex="-1"><a class="header-anchor" href="#_3-1-编译安装完整流程"><span>3.1 编译安装完整流程</span></a></h3>`,21),i(d,{code:``}),o[2]||=n(`<h3 id="_3-2-准备编译环境" tabindex="-1"><a class="header-anchor" href="#_3-2-准备编译环境"><span>3.2 准备编译环境</span></a></h3><h4 id="ubuntu-debian" tabindex="-1"><a class="header-anchor" href="#ubuntu-debian"><span>Ubuntu/Debian</span></a></h4><div class="language-bash line-numbers-mode" data-highlighter="shiki" data-ext="bash" style="background-color:#282c34;color:#abb2bf;"><pre class="shiki one-dark-pro vp-code"><code class="language-bash"><span class="line"><span style="color:#7F848E;font-style:italic;"># 更新系统</span></span>
