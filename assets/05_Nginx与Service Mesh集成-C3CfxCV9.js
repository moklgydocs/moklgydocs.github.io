import{A as e,E as t,d as n,l as r,p as i}from"./runtime-core.esm-bundler-tCF-J6l5.js";import{t as a}from"./app-BDkXanxw.js";var o=JSON.parse(`{"path":"/Linux/07_Nginx/08_%E9%AB%98%E7%BA%A7%E7%89%B9%E6%80%A7%E4%B8%8E%E6%89%A9%E5%B1%95/05_Nginx%E4%B8%8EService%20Mesh%E9%9B%86%E6%88%90.html","title":"Nginx 与 Service Mesh 集成","lang":"zh-CN","frontmatter":{"title":"Nginx 与 Service Mesh 集成","icon":"fa6-solid:network-wired","order":5,"category":["Linux","Nginx"],"tag":["Service Mesh","Istio","Sidecar","Envoy","微服务","流量管理"]},"git":{"createdTime":1780631738000,"updatedTime":1780632863000,"contributors":[{"name":"jackie.liu","username":"","email":"moklgy@foxmail.com","commits":2}]},"readingTime":{"minutes":18.13,"words":5440},"filePathRelative":"Linux/07_Nginx/08_高级特性与扩展/05_Nginx与Service Mesh集成.md"}`),s={name:`05_Nginx与Service Mesh集成.md`};function c(a,o,s,c,l,u){let d=e(`Mermaid`);return t(),r(`div`,null,[o[0]||=n(`<h1 id="nginx-与-service-mesh-集成" tabindex="-1"><a class="header-anchor" href="#nginx-与-service-mesh-集成"><span>Nginx 与 Service Mesh 集成</span></a></h1><p>Service Mesh 是微服务架构中处理服务间通信的基础设施层。Nginx 作为成熟的流量代理，在 Service Mesh 生态中扮演着重要角色——既可作为 Sidecar 代理，也可作为入口网关与 Mesh 协同工作。本文系统讲解 Nginx 在 Service Mesh 中的定位、与 Istio 的对比和集成方案，以及生产环境中的最佳实践。</p><hr><h2 id="_1-service-mesh-概述" tabindex="-1"><a class="header-anchor" href="#_1-service-mesh-概述"><span>1. Service Mesh 概述</span></a></h2><h3 id="_1-1-微服务通信的演进" tabindex="-1"><a class="header-anchor" href="#_1-1-微服务通信的演进"><span>1.1 微服务通信的演进</span></a></h3><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" style="background-color:#282c34;color:#abb2bf;"><pre class="shiki one-dark-pro vp-code"><code class="language-"><span class="line"><span>微服务通信演进历程：</span></span>
...
<span class="line"><span style="color:#C678DD;">        proxy_ssl_verify </span><span style="color:#D19A66;">on</span><span style="color:#ABB2BF;">;</span></span>
<span class="line"><span style="color:#ABB2BF;">    }</span></span>
<span class="line"><span style="color:#ABB2BF;">}</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><hr><h2 id="_3-nginx-与-istio-集成" tabindex="-1"><a class="header-anchor" href="#_3-nginx-与-istio-集成"><span>3. Nginx 与 Istio 集成</span></a></h2><h3 id="_3-1-架构-nginx-ingress-istio-mesh" tabindex="-1"><a class="header-anchor" href="#_3-1-架构-nginx-ingress-istio-mesh"><span>3.1 架构：Nginx Ingress + Istio Mesh</span></a></h3>`,11),i(d,{code:``}),o[3]||=n(`<h3 id="_3-2-nginx-ingress-配置优化" tabindex="-1"><a class="header-anchor" href="#_3-2-nginx-ingress-配置优化"><span>3.2 Nginx Ingress 配置优化</span></a></h3><div class="language-nginx line-numbers-mode" data-highlighter="shiki" data-ext="nginx" style="background-color:#282c34;color:#abb2bf;"><pre class="shiki one-dark-pro vp-code"><code class="language-nginx"><span class="line"><span style="color:#7F848E;font-style:italic;"># Nginx Ingress 与 Istio 集成的关键配置</span></span>
<span class="line"></span>
...
<span class="line"><span style="color:#ABB2BF;">    }</span></span>
<span class="line"><span style="color:#ABB2BF;">}</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><hr><h2 id="_4-nginx-service-mesh" tabindex="-1"><a class="header-anchor" href="#_4-nginx-service-mesh"><span>4. Nginx Service Mesh</span></a></h2><h3 id="_4-1-nginx-service-mesh-架构" tabindex="-1"><a class="header-anchor" href="#_4-1-nginx-service-mesh-架构"><span>4.1 Nginx Service Mesh 架构</span></a></h3><div class="hint-container warning"><p class="hint-container-title">NSM 已停止维护</p><p>Nginx Service Mesh (NSM) 已于 2023 年停止开发和维护，以下内容仅供学习参考。生产环境建议使用 Istio 或 Linkerd。</p></div><p>Nginx Service Mesh（NSM）是 F5/NGINX 推出的轻量级 Service Mesh 方案，使用 Nginx 作为 Sidecar 代理。</p>`,11),i(d,{code:``}),o[4]||=n(`<h3 id="_4-2-安装-nginx-service-mesh" tabindex="-1"><a class="header-anchor" href="#_4-2-安装-nginx-service-mesh"><span>4.2 安装 Nginx Service Mesh</span></a></h3><div class="language-bash line-numbers-mode" data-highlighter="shiki" data-ext="bash" style="background-color:#282c34;color:#abb2bf;"><pre class="shiki one-dark-pro vp-code"><code class="language-bash"><span class="line"><span style="color:#7F848E;font-style:italic;"># ===== 安装 Nginx Service Mesh =====</span></span>
<span class="line"></span>
...
<span class="line"><span>└── 两者通过标准 HTTP 头部协作</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><hr><h2 id="_6-分布式追踪集成" tabindex="-1"><a class="header-anchor" href="#_6-分布式追踪集成"><span>6. 分布式追踪集成</span></a></h2><h3 id="_6-1-追踪系统架构" tabindex="-1"><a class="header-anchor" href="#_6-1-追踪系统架构"><span>6.1 追踪系统架构</span></a></h3>`,15),i(d,{code:``}),o[5]||=n(`<h3 id="_6-2-nginx-生成追踪-id" tabindex="-1"><a class="header-anchor" href="#_6-2-nginx-生成追踪-id"><span>6.2 Nginx 生成追踪 ID</span></a></h3><div class="language-nginx line-numbers-mode" data-highlighter="shiki" data-ext="nginx" style="background-color:#282c34;color:#abb2bf;"><pre class="shiki one-dark-pro vp-code"><code class="language-nginx"><span class="line"><span style="color:#7F848E;font-style:italic;"># Nginx 作为入口网关生成分布式追踪 ID</span></span>
...
<span class="line"><span style="color:#E06C75;">      mode</span><span style="color:#ABB2BF;">: </span><span style="color:#98C379;">STRICT</span><span style="color:#7F848E;font-style:italic;">        # 服务间使用</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><hr><h2 id="_9-流量管理实战" tabindex="-1"><a class="header-anchor" href="#_9-流量管理实战"><span>9. 流量管理实战</span></a></h2><h3 id="_9-1-nginx-istio-灰度发布完整方案" tabindex="-1"><a class="header-anchor" href="#_9-1-nginx-istio-灰度发布完整方案"><span>9.1 Nginx + Istio 灰度发布完整方案</span></a></h3>`,7),i(d,{code:``}),o[7]||=n(`<div class="language-nginx line-numbers-mode" data-highlighter="shiki" data-ext="nginx" style="background-color:#282c34;color:#abb2bf;"><pre class="shiki one-dark-pro vp-code"><code class="language-nginx"><span class="line"><span style="color:#7F848E;font-style:italic;"># Nginx Ingress 灰度配置</span></span>
<span class="line"></span>
