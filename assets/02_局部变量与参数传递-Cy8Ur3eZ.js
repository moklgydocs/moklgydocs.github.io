...
<span class="line"><span>    pop ebp</span></span>
<span class="line"><span>    ret</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,12),i(p,{code:`eJxLy8kvT85ILCpRCHHiUgCC4tKk9KLEggyFFxuan09ZkZiS8nRC3/NZLc8WdDzdsRysBARSMotSk0sy8/MUnELggs7RSk/7m55N3ZBsa6wQ7eoUoG1oFqsUC5d3gskn2RpB5Y2Q5R1h8om2hhB5C2TpIKD8i/1Tns6e93TOhqdzGyBKTJCVAAWilZ7sn/t07Qygm4E8sBqYitS8FC4AhVNS1w==`}),c[4]||=o(`<h3 id="通过寄存器传参-64-位-system-v-abi" tabindex="-1"><a class="header-anchor" href="#通过寄存器传参-64-位-system-v-abi"><span>通过寄存器传参（64 位 System V ABI）</span></a></h3><p>64 位模式下，前 6 个整数参数通过寄存器传递，极大减少了内存访问：</p><div class="language-nasm line-numbers-mode" data-highlighter="shiki" data-ext="nasm" style="background-color:#282c34;color:#abb2bf;"><pre class="shiki one-dark-pro vp-code"><code class="language-nasm"><span class="line"><span>; 64 位调用 add(1, 2, 3)</span></span>
...
<span class="line"><span>    mov esp, ebp</span></span>
<span class="line"><span>    pop ebp</span></span>
<span class="line"><span>    ret 12                 ; stdcall: 清理 3 个参数</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="栈对齐" tabindex="-1"><a class="header-anchor" href="#栈对齐"><span>栈对齐</span></a></h2><h3 id="_64-位的-16-字节对齐要求" tabindex="-1"><a class="header-anchor" href="#_64-位的-16-字节对齐要求"><span>64 位的 16 字节对齐要求</span></a></h3><p>System V AMD64 ABI 要求在执行 CALL 指令时，栈必须 <strong>16 字节对齐</strong>：</p>`,18),i(p,{code:`eJxLy8kvT85ILCpR8AniUgACx2glZ0cfH4Wnnb0KQcEBCqoKhmYKtrYKBkqxCrq6dgpOMPm+7qetS1/sn/J09rynczY8ndugFAs2wAmszDlaCVm3BVTSGSzpEq0UEBrsoRDkFAAVdwGLu6JqAlrJBQBtCCyY`}),c[5]||=o(`<div class="hint-container warning"><p class="hint-container-title">对齐错误会导致段错误</p><p>如果调用 SSE/AVX 指令（如 printf 内部使用）时栈未 16 字节对齐，CPU 会触发<strong>通用保护异常</strong>，程序崩溃。这是 64 位汇编最常见的坑之一。</p><p>修正方法：在序言中多减 8 字节：</p><div class="language-nasm line-numbers-mode" data-highlighter="shiki" data-ext="nasm" style="background-color:#282c34;color:#abb2bf;"><pre class="shiki one-dark-pro vp-code"><code class="language-nasm"><span class="line"><span>push rbp</span></span>
