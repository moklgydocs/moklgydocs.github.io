import{M as e,O as t,c as n,d as r,h as i,m as a,p as o}from"./runtime-core.esm-bundler-jC72uHyJ.js";import{t as s}from"./app-CyWxe2cq.js";var c=JSON.parse(`{"path":"/%E8%AE%A1%E7%AE%97%E6%9C%BA%E5%AD%A6%E7%A7%91/%E6%B1%87%E7%BC%96%E8%AF%AD%E8%A8%80/05_%E7%B3%BB%E7%BB%9F%E8%B0%83%E7%94%A8%E4%B8%8EIO/03_%E5%86%85%E5%AD%98%E7%AE%A1%E7%90%86.html","title":"内存管理","lang":"zh-CN","frontmatter":{"title":"内存管理","icon":"fa6-solid:memory","order":3,"category":["计算机学科","汇编语言"],"tag":["内存"]},"git":{"createdTime":1780564101000,"updatedTime":1780564101000,"contributors":[{"name":"jackie.liu","username":"","email":"moklgy@foxmail.com","commits":1}]},"readingTime":{"minutes":6.97,"words":2092},"filePathRelative":"计算机学科/汇编语言/05_系统调用与IO/03_内存管理.md"}`),l={name:`03_内存管理.md`};function u(s,c,l,u,d,f){let p=e(`Mermaid`);return t(),r(`div`,null,[c[0]||=n(`h1`,{id:`内存管理`,tabindex:`-1`},[n(`a`,{class:`header-anchor`,href:`#内存管理`},[n(`span`,null,`内存管理`)])],-1),c[1]||=n(`h2`,{id:`从程序视角看内存`,tabindex:`-1`},[n(`a`,{class:`header-anchor`,href:`#从程序视角看内存`},[n(`span`,null,`从程序视角看内存`)])],-1),c[2]||=n(`p`,null,[a(`在汇编层面，你直接面对的是`),n(`strong`,null,`虚拟地址空间`),a(`——操作系统给每个进程营造的"独占内存"幻觉。理解进程的内存布局，是理解变量存储、动态分配、栈溢出等问题的前提。`)],-1),i(p,{code:``}),c[3]||=o(`<h2 id="进程内存布局详解" tabindex="-1"><a class="header-anchor" href="#进程内存布局详解"><span>进程内存布局详解</span></a></h2><h3 id="代码段-text" tabindex="-1"><a class="header-anchor" href="#代码段-text"><span>代码段（.text）</span></a></h3><p>存放机器指令，权限为<strong>可读可执行</strong>（r-x）。尝试写入会触发段错误。</p><div class="language-nasm line-numbers-mode" data-highlighter="shiki" data-ext="nasm" style="background-color:#282c34;color:#abb2bf;"><pre class="shiki one-dark-pro vp-code"><code class="language-nasm"><span class="line"><span>section .text</span></span>
...
<span class="line"><span>; call code_page</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="虚拟内存与物理内存" tabindex="-1"><a class="header-anchor" href="#虚拟内存与物理内存"><span>虚拟内存与物理内存</span></a></h2>`,11),i(p,{code:`eJxLy8kvT85ILCpR8AniUgCC4tKk9KLEggyFFzNnPeue/3TOhqdzG8AyIBDmGK1kUGFgYWBiYWBgYJNUpG/3Yv/s5yu6n8/pftqxQSkWrDI1LwXVrJcLt75YuAJuSkBItBJQ6PnsdU/3TlV41DYJqgDGfLawDZdJzztXPp/Q9rSt9enaGQjzwK4yNDI2MYW56um6eS9ntj7Z2/t87zo0s8IcFXR17YCOgFCOXABM8GNM`}),c[6]||=n(`ul`,null,[n(`li`,null,`每个进程有独立的页表，虚拟地址映射到不同的物理地址`),n(`li`,null,`未访问的页不占物理内存（按需分配）`),n(`li`,null,[a(`访问未映射的页触发`),n(`strong`,null,`缺页中断`),a(`（Page Fault），内核负责分配物理页`)])],-1),c[7]||=n(`div`,{class:`hint-container tip`},[n(`p`,{class:`hint-container-title`},`页大小`),n(`p`,null,`x86 默认页大小 4KB，x86-64 支持 2MB/1GB 大页（Huge Pages）。内存相关系统调用的参数必须是页对齐的。`)],-1),c[8]||=n(`h2`,{id:`小结`,tabindex:`-1`},[n(`a`,{class:`header-anchor`,href:`#小结`},[n(`span`,null,`小结`)])],-1),i(p,{code:``}),c[9]||=o(`<div class="hint-container tip"><p class="hint-container-title">面试要点</p><ul><li>进程内存布局：代码段→数据段→BSS→堆→ mmap→栈→内核空间</li><li><code>brk</code> 扩展堆，<code>mmap</code> 分配映射内存——两者是 malloc 的底层实现</li><li>BSS 段不占可执行文件空间，运行时由内核清零</li><li>栈向低地址增长，堆向高地址增长，碰头则内存耗尽</li><li>mmap 分配匿名内存是最灵活的分配方式，支持自定义权限</li><li>mprotect 可修改内存权限，实现&quot;先写后执行&quot;（W^X）安全策略</li><li>内存操作必须页对齐（4KB），否则系统调用会失败</li></ul></div><div class="hint-container info"><p class="hint-container-title">原著参考</p><p>本章内容参考自《汇编语言：基于Linux环境（第3版）》Jeff Duntemann 第13章&quot;Heading for 64-bit&quot;及第12章中关于内存管理的讨论。书中从程序员视角详细讲解了 Linux 内存管理接口。</p></div>`,2)])}var d=s(l,[[`render`,u]]);export{c as _pageData,d as default};