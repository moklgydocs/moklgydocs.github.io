...
<span class="line"><span style="color:#ABB2BF;">    }</span></span>
<span class="line"><span style="color:#ABB2BF;">}</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_8-grpc-健康检查协议" tabindex="-1"><a class="header-anchor" href="#_8-grpc-健康检查协议"><span>8. gRPC 健康检查协议</span></a></h2><h3 id="_8-0-健康检查架构" tabindex="-1"><a class="header-anchor" href="#_8-0-健康检查架构"><span>8.0 健康检查架构</span></a></h3>`,21),i(d,{code:``}),o[3]||=n(`<h3 id="_8-1-grpc-health-checking-protocol" tabindex="-1"><a class="header-anchor" href="#_8-1-grpc-health-checking-protocol"><span>8.1 gRPC Health Checking Protocol</span></a></h3><p>gRPC 定义了标准的健康检查协议 <code>grpc.health.v1.Health</code>：</p><div class="language-protobuf line-numbers-mode" data-highlighter="shiki" data-ext="protobuf" style="background-color:#282c34;color:#abb2bf;"><pre class="shiki one-dark-pro vp-code"><code class="language-protobuf"><span class="line"><span style="color:#7F848E;font-style:italic;">// grpc.health.v1.Health</span></span>
