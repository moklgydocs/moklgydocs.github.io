...
<span class="line"><span style="color:#ABB2BF;">    }</span></span>
<span class="line"><span style="color:#ABB2BF;">}</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><hr><h2 id="_4-nginx-service-mesh" tabindex="-1"><a class="header-anchor" href="#_4-nginx-service-mesh"><span>4. Nginx Service Mesh</span></a></h2><h3 id="_4-1-nginx-service-mesh-架构" tabindex="-1"><a class="header-anchor" href="#_4-1-nginx-service-mesh-架构"><span>4.1 Nginx Service Mesh 架构</span></a></h3><div class="hint-container warning"><p class="hint-container-title">NSM 已停止维护</p><p>Nginx Service Mesh (NSM) 已于 2023 年停止开发和维护，以下内容仅供学习参考。生产环境建议使用 Istio 或 Linkerd。</p></div><p>Nginx Service Mesh（NSM）是 F5/NGINX 推出的轻量级 Service Mesh 方案，使用 Nginx 作为 Sidecar 代理。</p>`,11),r(d,{code:``}),o[4]||=t(`<h3 id="_4-2-安装-nginx-service-mesh" tabindex="-1"><a class="header-anchor" href="#_4-2-安装-nginx-service-mesh"><span>4.2 安装 Nginx Service Mesh</span></a></h3><div class="language-bash line-numbers-mode" data-highlighter="shiki" data-ext="bash" style="background-color:#282c34;color:#abb2bf;"><pre class="shiki one-dark-pro vp-code"><code class="language-bash"><span class="line"><span style="color:#7F848E;font-style:italic;"># ===== 安装 Nginx Service Mesh =====</span></span>
<span class="line"></span>
...
<span class="line"><span>└── 两者通过标准 HTTP 头部协作</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><hr><h2 id="_6-分布式追踪集成" tabindex="-1"><a class="header-anchor" href="#_6-分布式追踪集成"><span>6. 分布式追踪集成</span></a></h2><h3 id="_6-1-追踪系统架构" tabindex="-1"><a class="header-anchor" href="#_6-1-追踪系统架构"><span>6.1 追踪系统架构</span></a></h3>`,15),r(d,{code:``}),o[5]||=t(`<h3 id="_6-2-nginx-生成追踪-id" tabindex="-1"><a class="header-anchor" href="#_6-2-nginx-生成追踪-id"><span>6.2 Nginx 生成追踪 ID</span></a></h3><div class="language-nginx line-numbers-mode" data-highlighter="shiki" data-ext="nginx" style="background-color:#282c34;color:#abb2bf;"><pre class="shiki one-dark-pro vp-code"><code class="language-nginx"><span class="line"><span style="color:#7F848E;font-style:italic;"># Nginx 作为入口网关生成分布式追踪 ID</span></span>
...
<span class="line"><span style="color:#E06C75;">      mode</span><span style="color:#ABB2BF;">: </span><span style="color:#98C379;">STRICT</span><span style="color:#7F848E;font-style:italic;">        # 服务间使用</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><hr><h2 id="_9-流量管理实战" tabindex="-1"><a class="header-anchor" href="#_9-流量管理实战"><span>9. 流量管理实战</span></a></h2><h3 id="_9-1-nginx-istio-灰度发布完整方案" tabindex="-1"><a class="header-anchor" href="#_9-1-nginx-istio-灰度发布完整方案"><span>9.1 Nginx + Istio 灰度发布完整方案</span></a></h3>`,7),r(d,{code:``}),o[7]||=t(`<div class="language-nginx line-numbers-mode" data-highlighter="shiki" data-ext="nginx" style="background-color:#282c34;color:#abb2bf;"><pre class="shiki one-dark-pro vp-code"><code class="language-nginx"><span class="line"><span style="color:#7F848E;font-style:italic;"># Nginx Ingress 灰度配置</span></span>
<span class="line"></span>
