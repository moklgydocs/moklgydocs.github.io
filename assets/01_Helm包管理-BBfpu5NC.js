import{D as e,f as t,j as n,m as r,s as i,u as a}from"./runtime-core.esm-bundler-D3eD_xTR.js";import{t as o}from"./app-BrkdHxfH.js";var s=JSON.parse(`{"path":"/%E8%BF%90%E7%BB%B4%E4%B8%8E%E9%83%A8%E7%BD%B2/Docker_K8s/07_Kubernetes%E7%94%9F%E4%BA%A7%E5%AE%9E%E6%88%98/01_Helm%E5%8C%85%E7%AE%A1%E7%90%86.html","title":"Helm 包管理","lang":"zh-CN","frontmatter":{"title":"Helm 包管理","icon":"package","order":1,"category":["Kubernetes生产实战"],"tag":["Helm","包管理","Chart","GitOps","Kustomize"]},"git":{"createdTime":1780623253000,"updatedTime":1780712648000,"contributors":[{"name":"jackie.liu","username":"","email":"moklgy@foxmail.com","commits":2}]},"readingTime":{"minutes":23.04,"words":6911},"filePathRelative":"运维与部署/Docker_K8s/07_Kubernetes生产实战/01_Helm包管理.md"}`),c={name:`01_Helm包管理.md`};function l(o,s,c,l,u,d){let f=n(`Mermaid`);return e(),a(`div`,null,[s[0]||=t(`<h1 id="helm-包管理" tabindex="-1"><a class="header-anchor" href="#helm-包管理"><span>Helm 包管理</span></a></h1><h2 id="helm-概述" tabindex="-1"><a class="header-anchor" href="#helm-概述"><span>Helm 概述</span></a></h2><p>Helm 是 Kubernetes 的官方包管理器，被誉为 &quot;Kubernetes 的 apt/yum&quot;。它将 Kubernetes 资源定义模板化，通过 Chart 的形式实现应用的一键部署、升级和回滚，极大地简化了复杂应用在 Kubernetes 上的生命周期管理。</p><div class="hint-container tip"><p class="hint-container-title">为什么需要 Helm？</p><p>一个典型的微服务应用可能包含 Deployment、Service、ConfigMap、Secret、Ingress 等数十个 YAML 文件。手动管理这些文件不仅繁琐，而且容易出错。Helm 通过模板化和参数化，让你用一套 Chart + 不同的 values 就能管理多个环境的部署。</p></div><h3 id="helm-版本演进" tabindex="-1"><a class="header-anchor" href="#helm-版本演进"><span>Helm 版本演进</span></a></h3>`,5),r(f,{code:``}),s[1]||=i(`h3`,{id:`helm-v2-vs-v3-架构对比`,tabindex:`-1`},[i(`a`,{class:`header-anchor`,href:`#helm-v2-vs-v3-架构对比`},[i(`span`,null,`Helm v2 vs v3 架构对比`)])],-1),r(f,{code:``}),s[2]||=t(`<div class="hint-container important"><p class="hint-container-title">Helm v3 的核心改进</p><ol><li><strong>移除 Tiller</strong>：v3 不再需要集群内的 Tiller 组件，直接通过 KubeConfig 与 API Server 交互，权限模型与 kubectl 一致</li><li><strong>Release 存储变更</strong>：从 ConfigMap 迁移到 Secret，默认加密存储更安全</li><li><strong>三方合并策略</strong>：升级时采用三方合并（旧 values + 旧 chart + 新 values），替代 v2 的双方合并</li><li><strong>OCI 注册表支持</strong>：可以将 Chart 推送到 OCI 兼容的镜像仓库</li></ol></div><hr><h2 id="helm-架构详解" tabindex="-1"><a class="header-anchor" href="#helm-架构详解"><span>Helm 架构详解</span></a></h2><h3 id="helm-v3-核心组件" tabindex="-1"><a class="header-anchor" href="#helm-v3-核心组件"><span>Helm v3 核心组件</span></a></h3>`,4),r(f,{code:``}),s[3]||=i(`h3`,{id:`helm-渲染流程`,tabindex:`-1`},[i(`a`,{class:`header-anchor`,href:`#helm-渲染流程`},[i(`span`,null,`Helm 渲染流程`)])],-1),r(f,{code:``}),s[4]||=i(`h3`,{id:`release-生命周期`,tabindex:`-1`},[i(`a`,{class:`header-anchor`,href:`#release-生命周期`},[i(`span`,null,`Release 生命周期`)])],-1),r(f,{code:``}),s[5]||=t(`<hr><h2 id="chart-目录结构" tabindex="-1"><a class="header-anchor" href="#chart-目录结构"><span>Chart 目录结构</span></a></h2><p>Chart 是 Helm 的核心打包格式，一个标准的 Chart 目录结构如下：</p><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" style="background-color:#282c34;color:#abb2bf;"><pre class="shiki one-dark-pro vp-code"><code class="language-"><span class="line"><span>myapp/</span></span>
...
<span class="line"><span style="color:#98C379;">    {{- end }}</span></span>
<span class="line"><span style="color:#98C379;">{{- end }}</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><hr><h2 id="子-chart-与依赖" tabindex="-1"><a class="header-anchor" href="#子-chart-与依赖"><span>子 Chart 与依赖</span></a></h2><h3 id="依赖管理" tabindex="-1"><a class="header-anchor" href="#依赖管理"><span>依赖管理</span></a></h3>`,23),r(f,{code:``}),s[7]||=t(`<h3 id="依赖声明-chart-yaml" tabindex="-1"><a class="header-anchor" href="#依赖声明-chart-yaml"><span>依赖声明（Chart.yaml）</span></a></h3><div class="language-yaml line-numbers-mode" data-highlighter="shiki" data-ext="yaml" style="background-color:#282c34;color:#abb2bf;"><pre class="shiki one-dark-pro vp-code"><code class="language-yaml"><span class="line"><span style="color:#7F848E;font-style:italic;"># Chart.yaml</span></span>
...
<span class="line"><span style="color:#ABB2BF;">      - </span><span style="color:#98C379;">ASPNETCORE_ENVIRONMENT=Production</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="选择建议" tabindex="-1"><a class="header-anchor" href="#选择建议"><span>选择建议</span></a></h3><div class="hint-container tip"><p class="hint-container-title">何时选择 Helm？</p><ul><li>需要分发应用给第三方使用</li><li>依赖大量社区 Chart（Redis、PostgreSQL 等）</li><li>需要 Release 管理和回滚能力</li><li>应用结构复杂，需要模板化</li></ul><p>何时选择 Kustomize？</p><ul><li>纯内部应用，不需要分发</li><li>已经有基础 YAML，只需环境差异配置</li><li>团队偏好声明式、无模板语法</li><li>与 ArgoCD 深度集成的 GitOps 场景</li></ul><p>可以混合使用！ArgoCD 原生支持 Helm + Kustomize 组合。</p></div><hr><h2 id="argocd-helm-集成" tabindex="-1"><a class="header-anchor" href="#argocd-helm-集成"><span>ArgoCD + Helm 集成</span></a></h2><h3 id="集成架构" tabindex="-1"><a class="header-anchor" href="#集成架构"><span>集成架构</span></a></h3>`,9),r(f,{code:``}),s[12]||=t(`<h3 id="argocd-application-配置" tabindex="-1"><a class="header-anchor" href="#argocd-application-配置"><span>ArgoCD Application 配置</span></a></h3><div class="language-yaml line-numbers-mode" data-highlighter="shiki" data-ext="yaml" style="background-color:#282c34;color:#abb2bf;"><pre class="shiki one-dark-pro vp-code"><code class="language-yaml"><span class="line"><span style="color:#7F848E;font-style:italic;"># Helm + ArgoCD Application</span></span>
