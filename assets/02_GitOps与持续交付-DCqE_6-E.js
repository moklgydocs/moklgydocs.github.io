import{A as e,E as t,d as n,l as r,p as i}from"./runtime-core.esm-bundler-tCF-J6l5.js";import{t as a}from"./app-BDkXanxw.js";var o=JSON.parse(`{"path":"/%E8%BF%90%E7%BB%B4%E4%B8%8E%E9%83%A8%E7%BD%B2/Docker_K8s/07_Kubernetes%E7%94%9F%E4%BA%A7%E5%AE%9E%E6%88%98/02_GitOps%E4%B8%8E%E6%8C%81%E7%BB%AD%E4%BA%A4%E4%BB%98.html","title":"GitOps 与持续交付","lang":"zh-CN","frontmatter":{"title":"GitOps 与持续交付","icon":"rocket","order":2,"category":["Kubernetes生产实战"],"tag":["GitOps","ArgoCD","Flux2","持续交付","渐进式发布"]},"git":{"createdTime":1780623253000,"updatedTime":1780623253000,"contributors":[{"name":"jackie.liu","username":"","email":"moklgy@foxmail.com","commits":1}]},"readingTime":{"minutes":19.65,"words":5895},"filePathRelative":"运维与部署/Docker_K8s/07_Kubernetes生产实战/02_GitOps与持续交付.md"}`),s={name:`02_GitOps与持续交付.md`};function c(a,o,s,c,l,u){let d=e(`Mermaid`);return t(),r(`div`,null,[o[0]||=n(`<h1 id="gitops-与持续交付" tabindex="-1"><a class="header-anchor" href="#gitops-与持续交付"><span>GitOps 与持续交付</span></a></h1><h2 id="gitops-概述" tabindex="-1"><a class="header-anchor" href="#gitops-概述"><span>GitOps 概述</span></a></h2><p>GitOps 是一种现代化的持续交付方法，由 Weaveworks 于 2017 年提出，其核心理念是<strong>将 Git 作为基础设施和应用配置的唯一真实来源（Single Source of Truth）</strong>，通过自动化同步机制确保集群状态与 Git 仓库中的声明式配置保持一致。</p><h3 id="gitops-四大原则" tabindex="-1"><a class="header-anchor" href="#gitops-四大原则"><span>GitOps 四大原则</span></a></h3>`,4),i(d,{code:``}),o[1]||=n(`<div class="hint-container tip"><p class="hint-container-title">GitOps 的核心价值</p><ol><li><strong>一致性</strong>：所有环境配置存储在 Git 中，环境间差异明确可控</li><li><strong>安全性</strong>：不需要给 CI 系统集群管理员权限，Git 控制变更流程</li><li><strong>可追溯</strong>：每次变更都有 Git commit 记录，支持审计和回滚</li><li><strong>可靠性</strong>：Git 作为唯一真实来源，避免了配置漂移</li><li><strong>协作性</strong>：通过 Pull Request 流程进行变更审批</li></ol></div><h3 id="gitops-vs-传统-ci-cd" tabindex="-1"><a class="header-anchor" href="#gitops-vs-传统-ci-cd"><span>GitOps vs 传统 CI/CD</span></a></h3>`,2),i(d,{code:``}),o[2]||=n(`<table><thead><tr><th>维度</th><th>传统 CI/CD</th><th>GitOps</th></tr></thead><tbody><tr><td><strong>同步模式</strong></td><td>Push（CI 推送到集群）</td><td>Pull（集群内控制器拉取）</td></tr><tr><td><strong>凭证管理</strong></td><td>CI 系统需要集群凭证</td><td>集群内运行，无需外部凭证</td></tr><tr><td><strong>配置来源</strong></td><td>CI 脚本 + 参数</td><td>Git 仓库声明式配置</td></tr><tr><td><strong>变更审计</strong></td><td>CI 日志</td><td>Git 提交历史</td></tr><tr><td><strong>回滚方式</strong></td><td>重新运行 CI 流水线</td><td><code>git revert</code> 即可回滚</td></tr><tr><td><strong>配置漂移</strong></td><td>难以检测</td><td>自动检测并修复</td></tr><tr><td><strong>多集群</strong></td><td>每个集群需要凭证</td><td>集群内控制器自治</td></tr></tbody></table><hr><h2 id="argocd-部署与配置" tabindex="-1"><a class="header-anchor" href="#argocd-部署与配置"><span>ArgoCD 部署与配置</span></a></h2><h3 id="argocd-架构" tabindex="-1"><a class="header-anchor" href="#argocd-架构"><span>ArgoCD 架构</span></a></h3>`,4),i(d,{code:``}),o[3]||=n(`<h3 id="安装-argocd" tabindex="-1"><a class="header-anchor" href="#安装-argocd"><span>安装 ArgoCD</span></a></h3><div class="language-bash line-numbers-mode" data-highlighter="shiki" data-ext="bash" style="background-color:#282c34;color:#abb2bf;"><pre class="shiki one-dark-pro vp-code"><code class="language-bash"><span class="line"><span style="color:#7F848E;font-style:italic;"># 创建命名空间</span></span>
...
<span class="line"><span style="color:#61AFEF;">argocd</span><span style="color:#98C379;"> app</span><span style="color:#98C379;"> diff</span><span style="color:#98C379;"> myapp-prod</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><hr><h2 id="多环境管理" tabindex="-1"><a class="header-anchor" href="#多环境管理"><span>多环境管理</span></a></h2><h3 id="app-of-apps-模式" tabindex="-1"><a class="header-anchor" href="#app-of-apps-模式"><span>App of Apps 模式</span></a></h3><p>App of Apps 是 ArgoCD 管理多应用和多环境的推荐模式：</p>`,9),i(d,{code:``}),o[5]||=n(`<div class="language-yaml line-numbers-mode" data-highlighter="shiki" data-ext="yaml" style="background-color:#282c34;color:#abb2bf;"><pre class="shiki one-dark-pro vp-code"><code class="language-yaml"><span class="line"><span style="color:#7F848E;font-style:italic;"># Root Application</span></span>
<span class="line"><span style="color:#E06C75;">apiVersion</span><span style="color:#ABB2BF;">: </span><span style="color:#98C379;">argoproj.io/v1alpha1</span></span>
<span class="line"><span style="color:#E06C75;">kind</span><span style="color:#ABB2BF;">: </span><span style="color:#98C379;">Application</span></span>
<span class="line"><span style="color:#E06C75;">metadata</span><span style="color:#ABB2BF;">:</span></span>
...
<span class="line"><span style="color:#E06C75;">          selfHeal</span><span style="color:#ABB2BF;">: </span><span style="color:#D19A66;">true</span></span>
<span class="line"><span style="color:#E06C75;">        syncOptions</span><span style="color:#ABB2BF;">:</span></span>
<span class="line"><span style="color:#ABB2BF;">          - </span><span style="color:#98C379;">CreateNamespace=true</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><hr><h2 id="自动同步与手动审批" tabindex="-1"><a class="header-anchor" href="#自动同步与手动审批"><span>自动同步与手动审批</span></a></h2><h3 id="多级审批工作流" tabindex="-1"><a class="header-anchor" href="#多级审批工作流"><span>多级审批工作流</span></a></h3>`,10),i(d,{code:``}),o[6]||=n(`<h3 id="argocd-notifications" tabindex="-1"><a class="header-anchor" href="#argocd-notifications"><span>ArgoCD Notifications</span></a></h3><div class="language-yaml line-numbers-mode" data-highlighter="shiki" data-ext="yaml" style="background-color:#282c34;color:#abb2bf;"><pre class="shiki one-dark-pro vp-code"><code class="language-yaml"><span class="line"><span style="color:#7F848E;font-style:italic;"># 通知配置</span></span>
<span class="line"><span style="color:#E06C75;">apiVersion</span><span style="color:#ABB2BF;">: </span><span style="color:#98C379;">v1</span></span>
<span class="line"><span style="color:#E06C75;">kind</span><span style="color:#ABB2BF;">: </span><span style="color:#98C379;">ConfigMap</span></span>
<span class="line"><span style="color:#E06C75;">metadata</span><span style="color:#ABB2BF;">:</span></span>
...
<span class="line"><span style="color:#E06C75;">      manualSync</span><span style="color:#ABB2BF;">: </span><span style="color:#D19A66;">false</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><hr><h2 id="net-应用-gitops-流水线" tabindex="-1"><a class="header-anchor" href="#net-应用-gitops-流水线"><span>.NET 应用 GitOps 流水线</span></a></h2><h3 id="完整流水线架构" tabindex="-1"><a class="header-anchor" href="#完整流水线架构"><span>完整流水线架构</span></a></h3>`,7),i(d,{code:``}),o[12]||=n(`<h3 id="ci-流水线-github-actions" tabindex="-1"><a class="header-anchor" href="#ci-流水线-github-actions"><span>CI 流水线（GitHub Actions）</span></a></h3><div class="language-yaml line-numbers-mode" data-highlighter="shiki" data-ext="yaml" style="background-color:#282c34;color:#abb2bf;"><pre class="shiki one-dark-pro vp-code"><code class="language-yaml"><span class="line"><span style="color:#7F848E;font-style:italic;"># .github/workflows/ci.yml</span></span>
