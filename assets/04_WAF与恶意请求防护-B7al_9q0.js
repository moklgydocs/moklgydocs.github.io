import{D as e,f as t,j as n,m as r,u as i}from"./runtime-core.esm-bundler-D3eD_xTR.js";import{t as a}from"./app-BrkdHxfH.js";var o=JSON.parse(`{"path":"/Linux/07_Nginx/06_%E9%99%90%E6%B5%81%E4%B8%8E%E8%AE%BF%E9%97%AE%E6%8E%A7%E5%88%B6/04_WAF%E4%B8%8E%E6%81%B6%E6%84%8F%E8%AF%B7%E6%B1%82%E9%98%B2%E6%8A%A4.html","title":"WAF 与恶意请求防护","lang":"zh-CN","frontmatter":{"title":"WAF 与恶意请求防护","icon":"fa6-solid:shield-virus","order":4,"category":["Linux","Nginx"],"tag":["WAF","ModSecurity","OWASP","SQL注入","XSS","DDoS","Bot检测"]},"git":{"createdTime":1780631738000,"updatedTime":1780712648000,"contributors":[{"name":"jackie.liu","username":"","email":"moklgy@foxmail.com","commits":3}]},"readingTime":{"minutes":29.79,"words":8937},"filePathRelative":"Linux/07_Nginx/06_限流与访问控制/04_WAF与恶意请求防护.md"}`),s={name:`04_WAF与恶意请求防护.md`};function c(a,o,s,c,l,u){let d=n(`Mermaid`);return e(),i(`div`,null,[o[0]||=t(`<h1 id="waf-与恶意请求防护" tabindex="-1"><a class="header-anchor" href="#waf-与恶意请求防护"><span>WAF 与恶意请求防护</span></a></h1><p>Web 应用防火墙（WAF）是 Nginx 安全体系的核心组件。与网络层防火墙不同，WAF 工作在应用层（OSI 第 7 层），能够深入解析 HTTP 请求内容，识别并拦截 SQL 注入、XSS 跨站脚本、文件包含、路径遍历等攻击。本文从 WAF 原理出发，系统讲解 ModSecurity 集成、OWASP CRS 规则集、常见攻击防护以及自定义规则编写。</p><hr><h2 id="_1-waf-原理与架构" tabindex="-1"><a class="header-anchor" href="#_1-waf-原理与架构"><span>1. WAF 原理与架构</span></a></h2><h3 id="_1-1-waf-在安全体系中的位置" tabindex="-1"><a class="header-anchor" href="#_1-1-waf-在安全体系中的位置"><span>1.1 WAF 在安全体系中的位置</span></a></h3>`,5),r(d,{code:``}),o[1]||=t(`<h3 id="_1-2-waf-工作模式" tabindex="-1"><a class="header-anchor" href="#_1-2-waf-工作模式"><span>1.2 WAF 工作模式</span></a></h3><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" style="background-color:#282c34;color:#abb2bf;"><pre class="shiki one-dark-pro vp-code"><code class="language-"><span class="line"><span>WAF 三种工作模式：</span></span>
